...
entry:
  ...
  call void @i64.array.append(ptr %.5, i64 84)
  call void @i64.array.append(ptr %.5, i64 101)
  call void @i64.array.append(ptr %.5, i64 115)
  call void @i64.array.append(ptr %.5, i64 116)
  call void @i64.array.append(ptr %.5, i64 32)
  call void @i64.array.append(ptr %.5, i64 99)
  call void @i64.array.append(ptr %.5, i64 111)
  call void @i64.array.append(ptr %.5, i64 109)
  call void @i64.array.append(ptr %.5, i64 112)
  call void @i64.array.append(ptr %.5, i64 108)
  call void @i64.array.append(ptr %.5, i64 101)
  call void @i64.array.append(ptr %.5, i64 116)
  call void @i64.array.append(ptr %.5, i64 101)
...
define void @SimpleClass.new(ptr %self, i64 %v) {
entry:
  %self.1 = alloca ptr, align 8
  store ptr %self, ptr %self.1, align 8
  %v.1 = alloca i64, align 8
  store i64 %v, ptr %v.1, align 4
  %.6 = load i64, ptr %v.1, align 4
  %.7 = load ptr, ptr %self.1, align 8
  %.8 = getelementptr inbounds %SimpleClass, ptr %.7, i32 0, i32 0
  %.9 = load i64, ptr %v.1, align 4
  store i64 %.9, ptr %.8, align 4
  %.11 = call ptr @malloc(i64 40)
  %.12 = bitcast ptr %.11 to ptr
  call void @i64.array.init(ptr %.12)
  call void @i64.array.append(ptr %.12, i64 67)
  call void @i64.array.append(ptr %.12, i64 114)
  call void @i64.array.append(ptr %.12, i64 101)
  call void @i64.array.append(ptr %.12, i64 97)
  call void @i64.array.append(ptr %.12, i64 116)
  call void @i64.array.append(ptr %.12, i64 101)
  call void @i64.array.append(ptr %.12, i64 100)
  call void @i64.array.append(ptr %.12, i64 58)
  call void @i64.array.append(ptr %.12, i64 32)
  call void @print(ptr %.12)
  %.24 = load i64, ptr %v.1, align 4
  %.25 = alloca [5 x i8], align 1
  store [5 x i8] c"%lld\00", ptr %.25, align 1
  %.27 = getelementptr [5 x i8], ptr %.25, i64 0, i64 0
  %.28 = call i32 (ptr, ...) @printf(ptr %.27, i64 %.24)
  %.29 = call i64 @putchar(i64 10)
  br label %exit
...
define void @SimpleClass.destroy(ptr %self) {
entry:
  %self.1 = alloca ptr, align 8
  store ptr %self, ptr %self.1, align 8
  %.4 = call ptr @malloc(i64 40)
  %.5 = bitcast ptr %.4 to ptr
  call void @i64.array.init(ptr %.5)
  call void @i64.array.append(ptr %.5, i64 68)
  call void @i64.array.append(ptr %.5, i64 101)
  call void @i64.array.append(ptr %.5, i64 115)
  call void @i64.array.append(ptr %.5, i64 116)
  call void @i64.array.append(ptr %.5, i64 114)
  call void @i64.array.append(ptr %.5, i64 111)
  call void @i64.array.append(ptr %.5, i64 121)
  call void @i64.array.append(ptr %.5, i64 101)
  call void @i64.array.append(ptr %.5, i64 100)
  call void @i64.array.append(ptr %.5, i64 58)
  call void @i64.array.append(ptr %.5, i64 32)
  call void @print(ptr %.5)
...
entry.endif:                                      ; preds = %entry
  %.29 = load %SimpleClass, ptr %.19, align 4
  %.30 = extractvalue %SimpleClass %.29, 0
  %.31 = alloca [5 x i8], align 1
  store [5 x i8] c"%lld\00", ptr %.31, align 1
  %.33 = getelementptr [5 x i8], ptr %.31, i64 0, i64 0
  %.34 = call i32 (ptr, ...) @printf(ptr %.33, i64 %.30)
  %.35 = call i64 @putchar(i64 10)
  br label %exit
}

define internal void @__destroy_SimpleClass__(ptr %.1) {
entry:
  %.3 = icmp eq ptr %.1, null
  br i1 %.3, label %exit, label %not_null
...
not_null:                                         ; preds = %entry
  call void @SimpleClass.destroy(ptr %.1)
  br label %exit
}
...
exit:                                             ; preds = %while.end
  ...
  br i1 %.66, label %rc_release_continue, label %rc_release

while.cond:                                       ; preds = %while.body, %entry
  %.4 = load i64, ptr %i, align 4
  %cmptmp = icmp slt i64 %.4, 3
  br i1 %cmptmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %.6 = call ptr @malloc(i64 24)
  %.7 = bitcast ptr %.6 to ptr
  %.8 = getelementptr %meteor.header, ptr %.7, i64 0, i32 0
  store i32 1, ptr %.8, align 4
  %.10 = getelementptr %meteor.header, ptr %.7, i64 0, i32 1
  store i32 0, ptr %.10, align 4
  %.12 = getelementptr %meteor.header, ptr %.7, i64 0, i32 2
  store i8 0, ptr %.12, align 1
  %.14 = getelementptr %meteor.header, ptr %.7, i64 0, i32 3
  store i8 10, ptr %.14, align 1
  %.16 = getelementptr i8, ptr %.6, i64 16
  %.17 = bitcast ptr %.16 to ptr
  %.18 = load i64, ptr %i, align 4
  call void @SimpleClass.new(ptr %.17, i64 %.18)
  store ptr %.17, ptr %obj, align 8
  %.22 = call ptr @malloc(i64 40)
  %.23 = bitcast ptr %.22 to ptr
  call void @i64.array.init(ptr %.23)
  call void @i64.array.append(ptr %.23, i64 76)
  call void @i64.array.append(ptr %.23, i64 111)
  call void @i64.array.append(ptr %.23, i64 111)
  ...
  call void @i64.array.append(ptr %.23, i64 114)
  call void @i64.array.append(ptr %.23, i64 97)
  call void @i64.array.append(ptr %.23, i64 116)
  call void @i64.array.append(ptr %.23, i64 105)
  call void @i64.array.append(ptr %.23, i64 111)
  call void @i64.array.append(ptr %.23, i64 110)
  call void @i64.array.append(ptr %.23, i64 58)
  call void @i64.array.append(ptr %.23, i64 32)
  call void @print(ptr %.23)
  %.42 = load i64, ptr %i, align 4
  %.43 = alloca [5 x i8], align 1
  store [5 x i8] c"%lld\00", ptr %.43, align 1
  %.45 = getelementptr [5 x i8], ptr %.43, i64 0, i64 0
  %.46 = call i32 (ptr, ...) @printf(ptr %.45, i64 %.42)
  %.47 = call i64 @putchar(i64 10)
...
while.end:                                        ; preds = %while.cond
  ...
  call void @i64.array.append(ptr %.52, i64 76)
  call void @i64.array.append(ptr %.52, i64 111)
  call void @i64.array.append(ptr %.52, i64 111)
  call void @i64.array.append(ptr %.52, i64 112)
  call void @i64.array.append(ptr %.52, i64 32)
  call void @i64.array.append(ptr %.52, i64 100)
  call void @i64.array.append(ptr %.52, i64 111)
  call void @i64.array.append(ptr %.52, i64 110)
  call void @i64.array.append(ptr %.52, i64 101)
...
rc_release:                                       ; preds = %exit
  ...
  %.73 = icmp eq i32 %.72, 1
  br i1 %.73, label %rc_destroy, label %rc_release_only

rc_release_continue:                              ; preds = %rc_release_only, %rc_destroy, %exit
  ret void

rc_destroy:                                       ; preds = %rc_release
  call void @__destroy_SimpleClass__(ptr %.65)
