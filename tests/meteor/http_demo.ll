...
entry:
  ...
  call void @meteor_retain(ptr %.12)
  store ptr %.11, ptr %.10, align 8
  %.15 = load ptr, ptr %value.1, align 8
  %.16 = load ptr, ptr %self.1, align 8
  %.17 = getelementptr inbounds %Header, ptr %.16, i32 0, i32 1
  %.18 = load ptr, ptr %value.1, align 8
  %.19 = bitcast ptr %.18 to ptr
...
entry:
  ...
  %.11 = bitcast ptr %.10 to ptr
  call void @meteor_retain(ptr %.11)
  store ptr %.10, ptr %.9, align 8
...
exit:                                             ; preds = %entry
  %.17 = load ptr, ptr %ret_var, align 8
  ret ptr %.17
}
...
entry:
  ...
  %.37 = load ptr, ptr %self.1, align 8
  %.38 = getelementptr inbounds %Response, ptr %.37, i32 0, i32 2
  %.39 = load ptr, ptr %content.1, align 8
  %.40 = bitcast ptr %.39 to ptr
  call void @meteor_retain(ptr %.40)
  store ptr %.39, ptr %.38, align 8
  %.43 = load ptr, ptr %self.1, align 8
  store ptr %.43, ptr %ret_var, align 8
  br label %exit
...
entry:
  ...
  store ptr %.44, ptr %ret_var, align 8
  br label %exit
...
entry:
  ...
  %.29 = load ptr, ptr %self.1, align 8
  %.30 = getelementptr inbounds %Response, ptr %.29, i32 0, i32 2
  %.31 = load ptr, ptr %content.1, align 8
  %.32 = bitcast ptr %.31 to ptr
  call void @meteor_retain(ptr %.32)
...
exit:                                             ; preds = %str_concat.right.end.1
  %.115 = load ptr, ptr %ret_var, align 8
  ret ptr %.115

str_concat.left.cond:                             ; preds = %str_concat.left.body, %entry
  %.63 = load i64, ptr %i_left, align 4
  %.64 = icmp slt i64 %.63, %left_len
  br i1 %.64, label %str_concat.left.body, label %str_concat.left.end

str_concat.left.body:                             ; preds = %str_concat.left.cond
  %.66 = load i64, ptr %i_left, align 4
  %left_char = call i64 @i64.array.get(ptr %.18, i64 %.66)
  call void @i64.array.append(ptr %.59, i64 %left_char)
  %.68 = add i64 %.66, 1
  store i64 %.68, ptr %i_left, align 4
  br label %str_concat.left.cond
...
str_concat.right.cond:                            ; preds = %str_concat.right.body, %str_concat.left.end
  %.73 = load i64, ptr %i_right, align 4
  %.74 = icmp slt i64 %.73, %right_len
  br i1 %.74, label %str_concat.right.body, label %str_concat.right.end

str_concat.right.body:                            ; preds = %str_concat.right.cond
  %.76 = load i64, ptr %i_right, align 4
  %right_char = call i64 @i64.array.get(ptr %.57, i64 %.76)
  call void @i64.array.append(ptr %.59, i64 %right_char)
  %.78 = add i64 %.76, 1
  store i64 %.78, ptr %i_right, align 4
  br label %str_concat.right.cond
...
str_concat.right.end:                             ; preds = %str_concat.right.cond
  ...
  %.82 = bitcast ptr %.81 to ptr
  call void @i64.array.init(ptr %.82)
  call void @i64.array.append(ptr %.82, i64 60)
  call void @i64.array.append(ptr %.82, i64 47)
  call void @i64.array.append(ptr %.82, i64 112)
  call void @i64.array.append(ptr %.82, i64 62)
  %.88 = call ptr @malloc(i64 40)
  %.89 = bitcast ptr %.88 to ptr
  call void @i64.array.init(ptr %.89)
  %left_len.1 = call i64 @i64.array.length(ptr %.59)
  %right_len.1 = call i64 @i64.array.length(ptr %.82)
...
str_concat.left.cond.1:                           ; preds = %str_concat.left.body.1, %str_concat.right.end
  %.93 = load i64, ptr %i_left.1, align 4
  %.94 = icmp slt i64 %.93, %left_len.1
  br i1 %.94, label %str_concat.left.body.1, label %str_concat.left.end.1

str_concat.left.body.1:                           ; preds = %str_concat.left.cond.1
  %.96 = load i64, ptr %i_left.1, align 4
  %left_char.1 = call i64 @i64.array.get(ptr %.59, i64 %.96)
  call void @i64.array.append(ptr %.89, i64 %left_char.1)
  %.98 = add i64 %.96, 1
  store i64 %.98, ptr %i_left.1, align 4
  br label %str_concat.left.cond.1
...
str_concat.right.cond.1:                          ; preds = %str_concat.right.body.1, %str_concat.left.end.1
  %.103 = load i64, ptr %i_right.1, align 4
  %.104 = icmp slt i64 %.103, %right_len.1
  br i1 %.104, label %str_concat.right.body.1, label %str_concat.right.end.1

str_concat.right.body.1:                          ; preds = %str_concat.right.cond.1
  %.106 = load i64, ptr %i_right.1, align 4
  %right_char.1 = call i64 @i64.array.get(ptr %.82, i64 %.106)
  call void @i64.array.append(ptr %.89, i64 %right_char.1)
  %.108 = add i64 %.106, 1
  store i64 %.108, ptr %i_right.1, align 4
  br label %str_concat.right.cond.1

str_concat.right.end.1:                           ; preds = %str_concat.right.cond.1
  %.111 = call ptr @Response.html(ptr %.16, ptr %.89)
  %.112 = load ptr, ptr %self.1, align 8
  store ptr %.112, ptr %ret_var, align 8
  br label %exit
}
...
entry:
  ...
  call void @meteor_retain(ptr %.19)
  store ptr %.18, ptr %.17, align 8
  %.22 = load ptr, ptr %handler.1, align 8
  %.23 = load ptr, ptr %self.1, align 8
  %.24 = getelementptr inbounds %Route, ptr %.23, i32 0, i32 2
  %.25 = load ptr, ptr %handler.1, align 8
...
entry:
  ...
  %.13 = bitcast ptr %.12 to ptr
  call void @meteor_retain(ptr %.13)
  store ptr %.12, ptr %.11, align 8
  %.16 = load i64, ptr %port.1, align 4
  %.17 = load ptr, ptr %self.1, align 8
  %.18 = getelementptr inbounds %Server, ptr %.17, i32 0, i32 2
  %.19 = load i64, ptr %port.1, align 4
  store i64 %.19, ptr %.18, align 4
  %.21 = load ptr, ptr %self.1, align 8
  %.22 = load %Server, ptr %.21, align 8
  %.23 = extractvalue %Server %.22, 0
  %.24 = load ptr, ptr %host.1, align 8
  %.25 = getelementptr %i64.array, ptr %.24, i32 0, i32 1
  %.26 = load i64, ptr %.25, align 4
  %.27 = getelementptr %i64.array, ptr %.24, i32 0, i32 3
...
exit:                                             ; preds = %str_conv_end
  %.59 = load ptr, ptr %ret_var, align 8
  ret ptr %.59

str_conv_cond:                                    ; preds = %str_conv_body, %entry
  %.34 = load i64, ptr %.31, align 4
  %.35 = icmp slt i64 %.34, %.26
  br i1 %.35, label %str_conv_body, label %str_conv_end

str_conv_body:                                    ; preds = %str_conv_cond
  %.37 = load i64, ptr %.31, align 4
  %.38 = getelementptr i64, ptr %.28, i64 %.37
  %.39 = load i64, ptr %.38, align 4
  %.40 = trunc i64 %.39 to i8
  %.41 = getelementptr i8, ptr %.30, i64 %.37
  store i8 %.40, ptr %.41, align 1
  %.43 = add i64 %.37, 1
  store i64 %.43, ptr %.31, align 4
  br label %str_conv_cond

str_conv_end:                                     ; preds = %str_conv_cond
  %.46 = getelementptr i8, ptr %.30, i64 %.26
  store i8 0, ptr %.46, align 1
  %.48 = call i32 @meteor_http_server_set_host(ptr %.23, ptr %.30)
  call void @free(ptr %.30)
  %.50 = load ptr, ptr %self.1, align 8
  %.51 = load %Server, ptr %.50, align 8
  %.52 = extractvalue %Server %.51, 0
  %.53 = load i64, ptr %port.1, align 4
  %.54 = trunc i64 %.53 to i32
  %.55 = call i32 @meteor_http_server_set_port(ptr %.52, i32 %.54)
  %.56 = load ptr, ptr %self.1, align 8
  store ptr %.56, ptr %ret_var, align 8
  br label %exit
}
...
entry:
  ...
  %.37 = load ptr, ptr %self.1, align 8
  store ptr %.37, ptr %ret_var, align 8
  br label %exit
...
entry:
  ...
  store ptr %.10, ptr %.9, align 8
  %.14 = load ptr, ptr %self.1, align 8
  %.15 = load %Server, ptr %.14, align 8
  %.16 = extractvalue %Server %.15, 0
  %.17 = load ptr, ptr %dir.1, align 8
  %.18 = getelementptr %i64.array, ptr %.17, i32 0, i32 1
  %.19 = load i64, ptr %.18, align 4
...
str_conv_cond:                                    ; preds = %str_conv_body, %entry
  ...
  br i1 %.28, label %str_conv_body, label %str_conv_end

str_conv_body:                                    ; preds = %str_conv_cond
  %.30 = load i64, ptr %.24, align 4
  %.31 = getelementptr i64, ptr %.21, i64 %.30
  %.32 = load i64, ptr %.31, align 4
  %.33 = trunc i64 %.32 to i8
  %.34 = getelementptr i8, ptr %.23, i64 %.30
...
str_conv_end:                                     ; preds = %str_conv_cond
  %.39 = getelementptr i8, ptr %.23, i64 %.19
  store i8 0, ptr %.39, align 1
  %.41 = call i32 @meteor_http_server_set_static_dir(ptr %.16, ptr %.23)
...
exit:                                             ; preds = %while.end
  %.784 = load i64, ptr %ret_var, align 4
  ret i64 %.784
...
if.end.1:                                         ; preds = %rc_release_continue.7, %if.start.1
  %.779 = load ptr, ptr %conn, align 8
  call void @meteor_http_connection_close(ptr %.779)
  br label %while.cond
...
frozen.continue.4:                                ; preds = %cstr_conv_end
  %.208 = bitcast ptr %.182 to ptr
  call void @meteor_retain(ptr %.208)
  store ptr %.182, ptr %.177, align 8
  %.211 = load ptr, ptr %req_ptr, align 8
  %.212 = call ptr @meteor_request_get_query(ptr %.211)
  %.213 = load ptr, ptr %req, align 8
  %.214 = getelementptr inbounds %Request, ptr %.213, i32 0, i32 2
  %.215 = load ptr, ptr %req_ptr, align 8
  %.216 = call ptr @meteor_request_get_query(ptr %.215)
  %.217 = call i64 @strlen(ptr %.216)
  %.218 = call ptr @malloc(i64 40)
  %.219 = bitcast ptr %.218 to ptr
  call void @i64.array.init(ptr %.219)
  %.221 = alloca i64, align 8
  store i64 0, ptr %.221, align 4
  br label %cstr_conv_cond.1

cstr_conv_cond.1:                                 ; preds = %cstr_conv_body.1, %frozen.continue.4
  %.224 = load i64, ptr %.221, align 4
  %.225 = icmp slt i64 %.224, %.217
  br i1 %.225, label %cstr_conv_body.1, label %cstr_conv_end.1

cstr_conv_body.1:                                 ; preds = %cstr_conv_cond.1
  %.227 = load i64, ptr %.221, align 4
  %.228 = getelementptr i8, ptr %.216, i64 %.227
  %.229 = load i8, ptr %.228, align 1
  %.230 = zext i8 %.229 to i64
  call void @i64.array.append(ptr %.219, i64 %.230)
  %.232 = add i64 %.227, 1
  store i64 %.232, ptr %.221, align 4
  br label %cstr_conv_cond.1

cstr_conv_end.1:                                  ; preds = %cstr_conv_cond.1
  %.235 = bitcast ptr %.213 to ptr
  %.236 = getelementptr i8, ptr %.235, i64 -16
  %.237 = bitcast ptr %.236 to ptr
  %.238 = getelementptr %meteor.header, ptr %.237, i64 0, i32 2
  %.239 = load i8, ptr %.238, align 1
  %.240 = and i8 %.239, 1
  %.241 = icmp ne i8 %.240, 0
  br i1 %.241, label %frozen.abort.5, label %frozen.continue.5
...
frozen.continue.5:                                ; preds = %cstr_conv_end.1
  %.245 = bitcast ptr %.219 to ptr
  call void @meteor_retain(ptr %.245)
  store ptr %.219, ptr %.214, align 8
  %.248 = load ptr, ptr %req_ptr, align 8
  %.249 = call ptr @meteor_request_get_body(ptr %.248)
  %.250 = load ptr, ptr %req, align 8
  %.251 = getelementptr inbounds %Request, ptr %.250, i32 0, i32 3
  %.252 = load ptr, ptr %req_ptr, align 8
  %.253 = call ptr @meteor_request_get_body(ptr %.252)
  %.254 = call i64 @strlen(ptr %.253)
  %.255 = call ptr @malloc(i64 40)
  %.256 = bitcast ptr %.255 to ptr
  call void @i64.array.init(ptr %.256)
  %.258 = alloca i64, align 8
  store i64 0, ptr %.258, align 4
  br label %cstr_conv_cond.2

cstr_conv_cond.2:                                 ; preds = %cstr_conv_body.2, %frozen.continue.5
  %.261 = load i64, ptr %.258, align 4
  %.262 = icmp slt i64 %.261, %.254
  br i1 %.262, label %cstr_conv_body.2, label %cstr_conv_end.2

cstr_conv_body.2:                                 ; preds = %cstr_conv_cond.2
  %.264 = load i64, ptr %.258, align 4
  %.265 = getelementptr i8, ptr %.253, i64 %.264
  %.266 = load i8, ptr %.265, align 1
  %.267 = zext i8 %.266 to i64
  call void @i64.array.append(ptr %.256, i64 %.267)
  %.269 = add i64 %.264, 1
  store i64 %.269, ptr %.258, align 4
  br label %cstr_conv_cond.2

cstr_conv_end.2:                                  ; preds = %cstr_conv_cond.2
  %.272 = bitcast ptr %.250 to ptr
  %.273 = getelementptr i8, ptr %.272, i64 -16
  %.274 = bitcast ptr %.273 to ptr
  %.275 = getelementptr %meteor.header, ptr %.274, i64 0, i32 2
  %.276 = load i8, ptr %.275, align 1
  %.277 = and i8 %.276, 1
  %.278 = icmp ne i8 %.277, 0
  br i1 %.278, label %frozen.abort.6, label %frozen.continue.6
...
frozen.continue.6:                                ; preds = %cstr_conv_end.2
  %.282 = bitcast ptr %.256 to ptr
  call void @meteor_retain(ptr %.282)
  store ptr %.256, ptr %.251, align 8
  %.285 = load ptr, ptr %req_ptr, align 8
  %.286 = call i32 @meteor_request_get_header_count(ptr %.285)
  store i32 %.286, ptr %count, align 4
  store i64 0, ptr %i, align 4
  br label %while.cond.1

while.cond.1:                                     ; preds = %cstr_conv_end.4, %frozen.continue.6
  %.290 = load i64, ptr %i, align 4
  %.291 = load i32, ptr %count, align 4
  %.292 = sext i32 %.291 to i64
  %cmptmp.4 = icmp slt i64 %.290, %.292
  br i1 %cmptmp.4, label %while.body.1, label %while.end.1

while.body.1:                                     ; preds = %while.cond.1
  %.294 = load ptr, ptr %req_ptr, align 8
  %.295 = load i64, ptr %i, align 4
  %.296 = trunc i64 %.295 to i32
  %.297 = call ptr @meteor_request_get_header_name_at(ptr %.294, i32 %.296)
  store ptr %.297, ptr %name, align 8
  %.299 = load ptr, ptr %req_ptr, align 8
  %.300 = load i64, ptr %i, align 4
  %.301 = trunc i64 %.300 to i32
  %.302 = call ptr @meteor_request_get_header_value_at(ptr %.299, i32 %.301)
  store ptr %.302, ptr %val, align 8
  %.304 = load ptr, ptr %req, align 8
  %.305 = load %Request, ptr %.304, align 8
  %.306 = extractvalue %Request %.305, 4
  %.307 = call ptr @malloc(i64 32)
  %.308 = bitcast ptr %.307 to ptr
  %.309 = getelementptr %meteor.header, ptr %.308, i64 0, i32 0
  store i32 1, ptr %.309, align 4
  %.311 = getelementptr %meteor.header, ptr %.308, i64 0, i32 1
  store i32 0, ptr %.311, align 4
  %.313 = getelementptr %meteor.header, ptr %.308, i64 0, i32 2
  store i8 0, ptr %.313, align 1
  %.315 = getelementptr %meteor.header, ptr %.308, i64 0, i32 3
  store i8 10, ptr %.315, align 1
  %.317 = getelementptr i8, ptr %.307, i64 16
  %.318 = bitcast ptr %.317 to ptr
  %.319 = getelementptr inbounds %Header, ptr %.318, i32 0, i32 0
  store ptr null, ptr %.319, align 8
  %.321 = getelementptr inbounds %Header, ptr %.318, i32 0, i32 1
  store ptr null, ptr %.321, align 8
  %.323 = load ptr, ptr %name, align 8
  %.324 = call i64 @strlen(ptr %.323)
...
while.end.1:                                      ; preds = %while.cond.1
  %.366 = call ptr @malloc(i64 40)
  %.367 = bitcast ptr %.366 to ptr
  %.368 = getelementptr %meteor.header, ptr %.367, i64 0, i32 0
  store i32 1, ptr %.368, align 4
  %.370 = getelementptr %meteor.header, ptr %.367, i64 0, i32 1
  store i32 0, ptr %.370, align 4
  %.372 = getelementptr %meteor.header, ptr %.367, i64 0, i32 2
  store i8 0, ptr %.372, align 1
  %.374 = getelementptr %meteor.header, ptr %.367, i64 0, i32 3
  store i8 10, ptr %.374, align 1
  %.376 = getelementptr i8, ptr %.366, i64 16
  %.377 = bitcast ptr %.376 to ptr
  %.378 = getelementptr inbounds %Response, ptr %.377, i32 0, i32 0
  store ptr null, ptr %.378, align 8
  %.380 = getelementptr inbounds %Response, ptr %.377, i32 0, i32 1
  store ptr null, ptr %.380, align 8
  %.382 = getelementptr inbounds %Response, ptr %.377, i32 0, i32 2
  store ptr null, ptr %.382, align 8
  call void @Response.new(ptr %.377)
  %.386 = load ptr, ptr %res, align 8
  %.387 = icmp ne ptr %.386, null
  br i1 %.387, label %while.end.1.if, label %while.end.1.endif

cstr_conv_cond.3:                                 ; preds = %cstr_conv_body.3, %while.body.1
  %.331 = load i64, ptr %.328, align 4
  %.332 = icmp slt i64 %.331, %.324
  br i1 %.332, label %cstr_conv_body.3, label %cstr_conv_end.3

cstr_conv_body.3:                                 ; preds = %cstr_conv_cond.3
  %.334 = load i64, ptr %.328, align 4
  %.335 = getelementptr i8, ptr %.323, i64 %.334
  %.336 = load i8, ptr %.335, align 1
  %.337 = zext i8 %.336 to i64
  call void @i64.array.append(ptr %.326, i64 %.337)
  %.339 = add i64 %.334, 1
  store i64 %.339, ptr %.328, align 4
  br label %cstr_conv_cond.3

cstr_conv_end.3:                                  ; preds = %cstr_conv_cond.3
  %.342 = load ptr, ptr %val, align 8
  %.343 = call i64 @strlen(ptr %.342)
  %.344 = call ptr @malloc(i64 40)
  %.345 = bitcast ptr %.344 to ptr
  call void @i64.array.init(ptr %.345)
...
cstr_conv_cond.4:                                 ; preds = %cstr_conv_body.4, %cstr_conv_end.3
  ...
  br i1 %.351, label %cstr_conv_body.4, label %cstr_conv_end.4

cstr_conv_body.4:                                 ; preds = %cstr_conv_cond.4
  %.353 = load i64, ptr %.347, align 4
  %.354 = getelementptr i8, ptr %.342, i64 %.353
  %.355 = load i8, ptr %.354, align 1
  %.356 = zext i8 %.355 to i64
  call void @i64.array.append(ptr %.345, i64 %.356)
  %.358 = add i64 %.353, 1
  store i64 %.358, ptr %.347, align 4
  br label %cstr_conv_cond.4

cstr_conv_end.4:                                  ; preds = %cstr_conv_cond.4
  call void @Header.new(ptr %.318, ptr %.326, ptr %.345)
  call void @Header.array.append(ptr %.306, ptr %.318)
  %.363 = load i64, ptr %i, align 4
  %addtmp = add i64 %.363, 1
  store i64 %addtmp, ptr %i, align 4
  br label %while.cond.1

while.end.1.if:                                   ; preds = %while.end.1
  %.389 = icmp eq ptr %.386, null
  br i1 %.389, label %rc_release_continue.1, label %rc_release.1

while.end.1.endif:                                ; preds = %rc_release_continue.1, %while.end.1
  store ptr %.377, ptr %res, align 8
  store i1 false, ptr %handled, align 1
  store i64 0, ptr %i, align 4
  br label %while.cond.2

rc_release.1:                                     ; preds = %while.end.1.if
  %.391 = bitcast ptr %.386 to ptr
  %.392 = getelementptr i8, ptr %.391, i64 -16
  %.393 = bitcast ptr %.392 to ptr
  %.394 = getelementptr %meteor.header, ptr %.393, i64 0, i32 0
  %.395 = load i32, ptr %.394, align 4
  %.396 = icmp eq i32 %.395, 1
  br i1 %.396, label %rc_destroy.1, label %rc_release_only.1

rc_release_continue.1:                            ; preds = %rc_release_only.1, %rc_destroy.1, %while.end.1.if
  br label %while.end.1.endif

rc_destroy.1:                                     ; preds = %rc_release.1
  call void @__destroy_Response__(ptr %.386)
  %.399 = bitcast ptr %.386 to ptr
  %.400 = getelementptr i8, ptr %.399, i64 -16
  %.401 = bitcast ptr %.400 to ptr
  call void @meteor_release(ptr %.401)
  br label %rc_release_continue.1

rc_release_only.1:                                ; preds = %rc_release.1
  %.404 = bitcast ptr %.386 to ptr
  %.405 = getelementptr i8, ptr %.404, i64 -16
  %.406 = bitcast ptr %.405 to ptr
  call void @meteor_release(ptr %.406)
  br label %rc_release_continue.1

while.cond.2:                                     ; preds = %if.end.3, %while.end.1.endif
  %.414 = load i64, ptr %i, align 4
  %.415 = load ptr, ptr %self.1, align 8
  %.416 = load %Server, ptr %.415, align 8
  %.417 = extractvalue %Server %.416, 3
  %.418 = call i64 @Route.array.length(ptr %.417)
  %cmptmp.5 = icmp slt i64 %.414, %.418
  br i1 %cmptmp.5, label %while.body.2, label %while.end.2

while.body.2:                                     ; preds = %while.cond.2
  %.420 = load i64, ptr %i, align 4
  %.421 = load ptr, ptr %self.1, align 8
  %.422 = load %Server, ptr %.421, align 8
  %.423 = extractvalue %Server %.422, 3
  %.424 = call ptr @Route.array.get(ptr %.423, i64 %.420)
  %.425 = bitcast ptr %.424 to ptr
  %.426 = getelementptr i8, ptr %.425, i64 -16
  %.427 = bitcast ptr %.426 to ptr
  call void @meteor_retain(ptr %.427)
  %.430 = load ptr, ptr %route, align 8
  %.431 = icmp ne ptr %.430, null
  br i1 %.431, label %while.body.2.if, label %while.body.2.endif
...
while.body.2.if:                                  ; preds = %while.body.2
  ...
  br i1 %.433, label %rc_release_continue.2, label %rc_release.2

while.body.2.endif:                               ; preds = %rc_release_continue.2, %while.body.2
  store ptr %.424, ptr %route, align 8
  br label %if.start.3

rc_release.2:                                     ; preds = %while.body.2.if
  %.435 = bitcast ptr %.430 to ptr
  %.436 = getelementptr i8, ptr %.435, i64 -16
  %.437 = bitcast ptr %.436 to ptr
  %.438 = getelementptr %meteor.header, ptr %.437, i64 0, i32 0
  %.439 = load i32, ptr %.438, align 4
  %.440 = icmp eq i32 %.439, 1
  br i1 %.440, label %rc_destroy.2, label %rc_release_only.2

rc_release_continue.2:                            ; preds = %rc_release_only.2, %rc_destroy.2, %while.body.2.if
  br label %while.body.2.endif

rc_destroy.2:                                     ; preds = %rc_release.2
  call void @__destroy_Route__(ptr %.430)
  %.443 = bitcast ptr %.430 to ptr
  %.444 = getelementptr i8, ptr %.443, i64 -16
  %.445 = bitcast ptr %.444 to ptr
  call void @meteor_release(ptr %.445)
  br label %rc_release_continue.2

rc_release_only.2:                                ; preds = %rc_release.2
  %.448 = bitcast ptr %.430 to ptr
  %.449 = getelementptr i8, ptr %.448, i64 -16
  %.450 = bitcast ptr %.449 to ptr
  call void @meteor_release(ptr %.450)
  br label %rc_release_continue.2

if.start.3:                                       ; preds = %while.body.2.endif
  %.456 = load ptr, ptr %route, align 8
  %.457 = load %Route, ptr %.456, align 8
  %.458 = extractvalue %Route %.457, 1
  %.459 = load ptr, ptr %req, align 8
  %.460 = load %Request, ptr %.459, align 8
  %.461 = extractvalue %Request %.460, 1
  %left_len = call i64 @i64.array.length(ptr %.458)
  %right_len = call i64 @i64.array.length(ptr %.461)
  %str_eq_result = alloca i1, align 1
  br label %str_eq.len_check

if.end.3:                                         ; preds = %str_eq.end
  %.491 = load i64, ptr %i, align 4
  %addtmp.1 = add i64 %.491, 1
  store i64 %addtmp.1, ptr %i, align 4
  br label %while.cond.2

if.true.0.3:                                      ; preds = %str_eq.end
  %.483 = load ptr, ptr %route, align 8
  %.484 = getelementptr %Route, ptr %.483, i32 0, i32 2
  %.485 = load ptr, ptr %.484, align 8
  %.486 = load ptr, ptr %req, align 8
  %.487 = load ptr, ptr %res, align 8
  %.488 = call ptr %.485(ptr %.486, ptr %.487)
  store i1 true, ptr %handled, align 1
  br label %while.end.2

str_eq.len_check:                                 ; preds = %if.start.3
  %.463 = icmp eq i64 %left_len, %right_len
  br i1 %.463, label %str_eq.compare, label %str_eq.len_mismatch
...
str_eq.loop_cond:                                 ; preds = %str_eq.loop_body, %str_eq.compare
  %.469 = load i64, ptr %i_cmp, align 4
  %.470 = icmp slt i64 %.469, %left_len
  br i1 %.470, label %str_eq.loop_body, label %str_eq.strings_equal

str_eq.loop_body:                                 ; preds = %str_eq.loop_cond
  %.472 = load i64, ptr %i_cmp, align 4
  %l_char = call i64 @i64.array.get(ptr %.458, i64 %.472)
  %r_char = call i64 @i64.array.get(ptr %.461, i64 %.472)
  %.473 = icmp eq i64 %l_char, %r_char
  %.474 = add i64 %.472, 1
  store i64 %.474, ptr %i_cmp, align 4
  br i1 %.473, label %str_eq.loop_cond, label %str_eq.char_mismatch
...
str_eq.end:                                       ; preds = %str_eq.strings_equal, %str_eq.char_mismatch, %str_eq.len_mismatch
  %.481 = load i1, ptr %str_eq_result, align 1
  br i1 %.481, label %if.true.0.3, label %if.end.3

if.start.4:                                       ; preds = %while.end.2
  %.495 = load i1, ptr %handled, align 1
  %.496 = xor i1 %.495, true
  br i1 %.496, label %if.true.0.4, label %if.end.4

if.end.4:                                         ; preds = %if.true.0.4, %if.start.4
  %.501 = call ptr @meteor_http_response_create()
  store ptr %.501, ptr %res_ptr, align 8
  store i64 200, ptr %status_code, align 4
  br label %if.start.5

if.true.0.4:                                      ; preds = %if.start.4
  %.498 = load ptr, ptr %res, align 8
  %.499 = call ptr @Response.not_found(ptr %.498)
  br label %if.end.4

if.start.5:                                       ; preds = %if.end.4
  %.505 = load ptr, ptr %res, align 8
  %.506 = load %Response, ptr %.505, align 8
  %.507 = extractvalue %Response %.506, 0
  %.508 = alloca %HttpStatus, align 8
  %.509 = getelementptr inbounds %HttpStatus, ptr %.508, i32 0, i32 0
  store i8 0, ptr %.509, align 1
  %.511 = load %HttpStatus, ptr %.507, align 1
  %.512 = load %HttpStatus, ptr %.508, align 1
  %.513 = extractvalue %HttpStatus %.511, 0
  %.514 = extractvalue %HttpStatus %.512, 0
  %cmptmp.6 = icmp eq i8 %.513, %.514
  br i1 %cmptmp.6, label %if.true.0.5, label %if.false.0.1

if.end.5:                                         ; preds = %if.true.2.1, %if.false.1.1, %if.true.1.1, %if.true.0.5
  %.544 = load ptr, ptr %res_ptr, align 8
  %.545 = load i64, ptr %status_code, align 4
  %.546 = trunc i64 %.545 to i32
  %.547 = call i32 @meteor_http_response_set_status(ptr %.544, i32 %.546)
  store i64 0, ptr %i, align 4
...
if.false.0.1:                                     ; preds = %if.start.5
  %.518 = load ptr, ptr %res, align 8
  %.519 = load %Response, ptr %.518, align 8
  %.520 = extractvalue %Response %.519, 0
  %.521 = alloca %HttpStatus, align 8
  %.522 = getelementptr inbounds %HttpStatus, ptr %.521, i32 0, i32 0
  store i8 9, ptr %.522, align 1
  %.524 = load %HttpStatus, ptr %.520, align 1
  %.525 = load %HttpStatus, ptr %.521, align 1
  %.526 = extractvalue %HttpStatus %.524, 0
  %.527 = extractvalue %HttpStatus %.525, 0
  %cmptmp.7 = icmp eq i8 %.526, %.527
...
if.false.1.1:                                     ; preds = %if.false.0.1
  %.531 = load ptr, ptr %res, align 8
  %.532 = load %Response, ptr %.531, align 8
  %.533 = extractvalue %Response %.532, 0
  %.534 = alloca %HttpStatus, align 8
  %.535 = getelementptr inbounds %HttpStatus, ptr %.534, i32 0, i32 0
  store i8 11, ptr %.535, align 1
  %.537 = load %HttpStatus, ptr %.533, align 1
  %.538 = load %HttpStatus, ptr %.534, align 1
  %.539 = extractvalue %HttpStatus %.537, 0
  %.540 = extractvalue %HttpStatus %.538, 0
  %cmptmp.8 = icmp eq i8 %.539, %.540
...
while.cond.3:                                     ; preds = %str_conv_end.1, %if.end.5
  %.550 = load i64, ptr %i, align 4
  %.551 = load ptr, ptr %res, align 8
  %.552 = load %Response, ptr %.551, align 8
  %.553 = extractvalue %Response %.552, 1
  %.554 = call i64 @Header.array.length(ptr %.553)
  %cmptmp.9 = icmp slt i64 %.550, %.554
  br i1 %cmptmp.9, label %while.body.3, label %while.end.3

while.body.3:                                     ; preds = %while.cond.3
  %.556 = load i64, ptr %i, align 4
  %.557 = load ptr, ptr %res, align 8
  %.558 = load %Response, ptr %.557, align 8
  %.559 = extractvalue %Response %.558, 1
  %.560 = call ptr @Header.array.get(ptr %.559, i64 %.556)
  %.561 = bitcast ptr %.560 to ptr
  %.562 = getelementptr i8, ptr %.561, i64 -16
  %.563 = bitcast ptr %.562 to ptr
  call void @meteor_retain(ptr %.563)
  %.566 = load ptr, ptr %h, align 8
  %.567 = icmp ne ptr %.566, null
  br i1 %.567, label %while.body.3.if, label %while.body.3.endif

while.end.3:                                      ; preds = %while.cond.3
  %.650 = load ptr, ptr %res_ptr, align 8
  %.651 = load ptr, ptr %res, align 8
  %.652 = load %Response, ptr %.651, align 8
  %.653 = extractvalue %Response %.652, 2
  %.654 = getelementptr %i64.array, ptr %.653, i32 0, i32 1
  %.655 = load i64, ptr %.654, align 4
  %.656 = getelementptr %i64.array, ptr %.653, i32 0, i32 3
  %.657 = load ptr, ptr %.656, align 8
  %.658 = add i64 %.655, 1
  %.659 = call ptr @malloc(i64 %.658)
...
while.body.3.if:                                  ; preds = %while.body.3
  ...
  br i1 %.569, label %rc_release_continue.3, label %rc_release.3

while.body.3.endif:                               ; preds = %rc_release_continue.3, %while.body.3
  store ptr %.560, ptr %h, align 8
  %.591 = load ptr, ptr %res_ptr, align 8
  %.592 = load ptr, ptr %h, align 8
  %.593 = load %Header, ptr %.592, align 8
  %.594 = extractvalue %Header %.593, 0
  %.595 = getelementptr %i64.array, ptr %.594, i32 0, i32 1
  %.596 = load i64, ptr %.595, align 4
  %.597 = getelementptr %i64.array, ptr %.594, i32 0, i32 3
  %.598 = load ptr, ptr %.597, align 8
  %.599 = add i64 %.596, 1
  %.600 = call ptr @malloc(i64 %.599)
  %.601 = alloca i64, align 8
  store i64 0, ptr %.601, align 4
  br label %str_conv_cond

rc_release.3:                                     ; preds = %while.body.3.if
  %.571 = bitcast ptr %.566 to ptr
  %.572 = getelementptr i8, ptr %.571, i64 -16
  %.573 = bitcast ptr %.572 to ptr
  %.574 = getelementptr %meteor.header, ptr %.573, i64 0, i32 0
  %.575 = load i32, ptr %.574, align 4
  %.576 = icmp eq i32 %.575, 1
  br i1 %.576, label %rc_destroy.3, label %rc_release_only.3

rc_release_continue.3:                            ; preds = %rc_release_only.3, %rc_destroy.3, %while.body.3.if
  br label %while.body.3.endif

rc_destroy.3:                                     ; preds = %rc_release.3
  call void @__destroy_Header__(ptr %.566)
  %.579 = bitcast ptr %.566 to ptr
  %.580 = getelementptr i8, ptr %.579, i64 -16
  %.581 = bitcast ptr %.580 to ptr
  call void @meteor_release(ptr %.581)
  br label %rc_release_continue.3

rc_release_only.3:                                ; preds = %rc_release.3
  %.584 = bitcast ptr %.566 to ptr
  %.585 = getelementptr i8, ptr %.584, i64 -16
  %.586 = bitcast ptr %.585 to ptr
  call void @meteor_release(ptr %.586)
  br label %rc_release_continue.3

str_conv_cond:                                    ; preds = %str_conv_body, %while.body.3.endif
  %.604 = load i64, ptr %.601, align 4
  %.605 = icmp slt i64 %.604, %.596
  br i1 %.605, label %str_conv_body, label %str_conv_end

str_conv_body:                                    ; preds = %str_conv_cond
  %.607 = load i64, ptr %.601, align 4
  %.608 = getelementptr i64, ptr %.598, i64 %.607
  %.609 = load i64, ptr %.608, align 4
  %.610 = trunc i64 %.609 to i8
  %.611 = getelementptr i8, ptr %.600, i64 %.607
  store i8 %.610, ptr %.611, align 1
  %.613 = add i64 %.607, 1
  store i64 %.613, ptr %.601, align 4
  br label %str_conv_cond

str_conv_end:                                     ; preds = %str_conv_cond
  %.616 = getelementptr i8, ptr %.600, i64 %.596
  store i8 0, ptr %.616, align 1
  %.618 = load ptr, ptr %h, align 8
  %.619 = load %Header, ptr %.618, align 8
  %.620 = extractvalue %Header %.619, 1
  %.621 = getelementptr %i64.array, ptr %.620, i32 0, i32 1
  %.622 = load i64, ptr %.621, align 4
  %.623 = getelementptr %i64.array, ptr %.620, i32 0, i32 3
  %.624 = load ptr, ptr %.623, align 8
  %.625 = add i64 %.622, 1
  %.626 = call ptr @malloc(i64 %.625)
...
str_conv_cond.1:                                  ; preds = %str_conv_body.1, %str_conv_end
  %.630 = load i64, ptr %.627, align 4
  %.631 = icmp slt i64 %.630, %.622
  br i1 %.631, label %str_conv_body.1, label %str_conv_end.1

str_conv_body.1:                                  ; preds = %str_conv_cond.1
  %.633 = load i64, ptr %.627, align 4
  %.634 = getelementptr i64, ptr %.624, i64 %.633
  %.635 = load i64, ptr %.634, align 4
  %.636 = trunc i64 %.635 to i8
  %.637 = getelementptr i8, ptr %.626, i64 %.633
  store i8 %.636, ptr %.637, align 1
  %.639 = add i64 %.633, 1
  store i64 %.639, ptr %.627, align 4
  br label %str_conv_cond.1

str_conv_end.1:                                   ; preds = %str_conv_cond.1
  %.642 = getelementptr i8, ptr %.626, i64 %.622
  store i8 0, ptr %.642, align 1
  %.644 = call i32 @meteor_http_response_set_header(ptr %.591, ptr %.600, ptr %.626)
  call void @free(ptr %.600)
  call void @free(ptr %.626)
  %.647 = load i64, ptr %i, align 4
  %addtmp.2 = add i64 %.647, 1
  store i64 %addtmp.2, ptr %i, align 4
  br label %while.cond.3

str_conv_cond.2:                                  ; preds = %str_conv_body.2, %while.end.3
  %.663 = load i64, ptr %.660, align 4
  %.664 = icmp slt i64 %.663, %.655
  br i1 %.664, label %str_conv_body.2, label %str_conv_end.2

str_conv_body.2:                                  ; preds = %str_conv_cond.2
  %.666 = load i64, ptr %.660, align 4
  %.667 = getelementptr i64, ptr %.657, i64 %.666
  %.668 = load i64, ptr %.667, align 4
  %.669 = trunc i64 %.668 to i8
  %.670 = getelementptr i8, ptr %.659, i64 %.666
  store i8 %.669, ptr %.670, align 1
  %.672 = add i64 %.666, 1
  store i64 %.672, ptr %.660, align 4
  br label %str_conv_cond.2

str_conv_end.2:                                   ; preds = %str_conv_cond.2
  %.675 = getelementptr i8, ptr %.659, i64 %.655
  store i8 0, ptr %.675, align 1
  %.677 = load ptr, ptr %res, align 8
  %.678 = load %Response, ptr %.677, align 8
  %.679 = extractvalue %Response %.678, 2
  %.680 = call i64 @i64.array.length(ptr %.679)
  %.681 = call i32 @meteor_http_response_set_body(ptr %.650, ptr %.659, i64 %.680)
  call void @free(ptr %.659)
  %.683 = load ptr, ptr %conn, align 8
  %.684 = load ptr, ptr %res_ptr, align 8
  %.685 = call i32 @meteor_http_connection_send_response(ptr %.683, ptr %.684)
  %.686 = load ptr, ptr %res_ptr, align 8
  call void @meteor_http_response_free(ptr %.686)
  %.688 = load ptr, ptr %req_ptr, align 8
  call void @meteor_http_request_free(ptr %.688)
  %.690 = load ptr, ptr %req, align 8
  %.691 = icmp eq ptr %.690, null
  br i1 %.691, label %rc_release_continue.4, label %rc_release.4

rc_release.4:                                     ; preds = %str_conv_end.2
  %.693 = bitcast ptr %.690 to ptr
  %.694 = getelementptr i8, ptr %.693, i64 -16
  %.695 = bitcast ptr %.694 to ptr
  %.696 = getelementptr %meteor.header, ptr %.695, i64 0, i32 0
  %.697 = load i32, ptr %.696, align 4
  %.698 = icmp eq i32 %.697, 1
  br i1 %.698, label %rc_destroy.4, label %rc_release_only.4

rc_release_continue.4:                            ; preds = %rc_release_only.4, %rc_destroy.4, %str_conv_end.2
  store ptr null, ptr %req, align 8
  %.712 = load ptr, ptr %res, align 8
  %.713 = icmp eq ptr %.712, null
  br i1 %.713, label %rc_release_continue.5, label %rc_release.5

rc_destroy.4:                                     ; preds = %rc_release.4
  call void @__destroy_Request__(ptr %.690)
  %.701 = bitcast ptr %.690 to ptr
  %.702 = getelementptr i8, ptr %.701, i64 -16
  %.703 = bitcast ptr %.702 to ptr
  call void @meteor_release(ptr %.703)
  br label %rc_release_continue.4

rc_release_only.4:                                ; preds = %rc_release.4
  %.706 = bitcast ptr %.690 to ptr
  %.707 = getelementptr i8, ptr %.706, i64 -16
  %.708 = bitcast ptr %.707 to ptr
  call void @meteor_release(ptr %.708)
  br label %rc_release_continue.4

rc_release.5:                                     ; preds = %rc_release_continue.4
  %.715 = bitcast ptr %.712 to ptr
  %.716 = getelementptr i8, ptr %.715, i64 -16
  %.717 = bitcast ptr %.716 to ptr
  %.718 = getelementptr %meteor.header, ptr %.717, i64 0, i32 0
  %.719 = load i32, ptr %.718, align 4
  %.720 = icmp eq i32 %.719, 1
  br i1 %.720, label %rc_destroy.5, label %rc_release_only.5

rc_release_continue.5:                            ; preds = %rc_release_only.5, %rc_destroy.5, %rc_release_continue.4
  store ptr null, ptr %res, align 8
  %.734 = load ptr, ptr %route, align 8
  %.735 = icmp eq ptr %.734, null
  br i1 %.735, label %rc_release_continue.6, label %rc_release.6

rc_destroy.5:                                     ; preds = %rc_release.5
  call void @__destroy_Response__(ptr %.712)
  %.723 = bitcast ptr %.712 to ptr
  %.724 = getelementptr i8, ptr %.723, i64 -16
  %.725 = bitcast ptr %.724 to ptr
  call void @meteor_release(ptr %.725)
  br label %rc_release_continue.5

rc_release_only.5:                                ; preds = %rc_release.5
  %.728 = bitcast ptr %.712 to ptr
  %.729 = getelementptr i8, ptr %.728, i64 -16
  %.730 = bitcast ptr %.729 to ptr
  call void @meteor_release(ptr %.730)
  br label %rc_release_continue.5

rc_release.6:                                     ; preds = %rc_release_continue.5
  %.737 = bitcast ptr %.734 to ptr
  %.738 = getelementptr i8, ptr %.737, i64 -16
  %.739 = bitcast ptr %.738 to ptr
  %.740 = getelementptr %meteor.header, ptr %.739, i64 0, i32 0
  %.741 = load i32, ptr %.740, align 4
  %.742 = icmp eq i32 %.741, 1
  br i1 %.742, label %rc_destroy.6, label %rc_release_only.6

rc_release_continue.6:                            ; preds = %rc_release_only.6, %rc_destroy.6, %rc_release_continue.5
  store ptr null, ptr %route, align 8
  %.756 = load ptr, ptr %h, align 8
  %.757 = icmp eq ptr %.756, null
  br i1 %.757, label %rc_release_continue.7, label %rc_release.7

rc_destroy.6:                                     ; preds = %rc_release.6
  call void @__destroy_Route__(ptr %.734)
  %.745 = bitcast ptr %.734 to ptr
  %.746 = getelementptr i8, ptr %.745, i64 -16
  %.747 = bitcast ptr %.746 to ptr
  call void @meteor_release(ptr %.747)
  br label %rc_release_continue.6

rc_release_only.6:                                ; preds = %rc_release.6
  %.750 = bitcast ptr %.734 to ptr
  %.751 = getelementptr i8, ptr %.750, i64 -16
  %.752 = bitcast ptr %.751 to ptr
  call void @meteor_release(ptr %.752)
  br label %rc_release_continue.6

rc_release.7:                                     ; preds = %rc_release_continue.6
  %.759 = bitcast ptr %.756 to ptr
  %.760 = getelementptr i8, ptr %.759, i64 -16
  %.761 = bitcast ptr %.760 to ptr
  %.762 = getelementptr %meteor.header, ptr %.761, i64 0, i32 0
  %.763 = load i32, ptr %.762, align 4
  %.764 = icmp eq i32 %.763, 1
  br i1 %.764, label %rc_destroy.7, label %rc_release_only.7

rc_release_continue.7:                            ; preds = %rc_release_only.7, %rc_destroy.7, %rc_release_continue.6
  store ptr null, ptr %h, align 8
  br label %if.end.1

rc_destroy.7:                                     ; preds = %rc_release.7
  call void @__destroy_Header__(ptr %.756)
  %.767 = bitcast ptr %.756 to ptr
  %.768 = getelementptr i8, ptr %.767, i64 -16
  %.769 = bitcast ptr %.768 to ptr
  call void @meteor_release(ptr %.769)
  br label %rc_release_continue.7

rc_release_only.7:                                ; preds = %rc_release.7
  %.772 = bitcast ptr %.756 to ptr
  %.773 = getelementptr i8, ptr %.772, i64 -16
  %.774 = bitcast ptr %.773 to ptr
  call void @meteor_release(ptr %.774)
  br label %rc_release_continue.7
}
...
exit:                                             ; preds = %rc_release_continue.14, %if.true.0.endif
  %.532 = load ptr, ptr %ret_var, align 8
  ret ptr %.532
...
if.end.2:                                         ; preds = %str_concat.right.end.9.endif, %str_concat.right.end.8.endif, %if.false.8, %str_concat.right.end.7.endif, %str_concat.right.end.6.endif, %str_concat.right.end.5.endif, %str_concat.right.end.4.endif, %str_concat.right.end.3.endif, %str_concat.right.end.2.endif, %str_concat.right.end.1.endif, %str_concat.right.end.endif
  %.464 = load i64, ptr %num, align 4
  %.465 = sitofp i64 %.464 to double
  %.466 = sitofp i64 10 to double
  %fdivtmp = fdiv double %.465, %.466
  %.467 = fptosi double %fdivtmp to i64
  store i64 %.467, ptr %num, align 4
  br label %while.cond
...
if.false.0:                                       ; preds = %if.start.2
  %.96 = load i64, ptr %d, align 4
  %cmptmp.4 = icmp eq i64 %.96, 1
...
str_concat.left.body:                             ; preds = %str_concat.left.cond
  ...
  %left_char = call i64 @i64.array.get(ptr %.58, i64 %.70)
...
str_concat.right.body:                            ; preds = %str_concat.right.cond
  ...
  %right_char = call i64 @i64.array.get(ptr %.61, i64 %.80)
...
str_concat.right.end:                             ; preds = %str_concat.right.cond
  ...
  br i1 %.86, label %str_concat.right.end.if, label %str_concat.right.end.endif

str_concat.right.end.if:                          ; preds = %str_concat.right.end
  %.88 = icmp eq ptr %.85, null
  br i1 %.88, label %rc_release_continue.2, label %rc_release.2

str_concat.right.end.endif:                       ; preds = %rc_release_continue.2, %str_concat.right.end
  store ptr %.63, ptr %result, align 8
  br label %if.end.2

rc_release.2:                                     ; preds = %str_concat.right.end.if
  %.90 = bitcast ptr %.85 to ptr
  call void @meteor_release(ptr %.90)
  br label %rc_release_continue.2

rc_release_continue.2:                            ; preds = %rc_release.2, %str_concat.right.end.if
  br label %str_concat.right.end.endif

if.true.1:                                        ; preds = %if.false.0
  %.98 = call ptr @malloc(i64 40)
  %.99 = bitcast ptr %.98 to ptr
  call void @i64.array.init(ptr %.99)
  call void @i64.array.append(ptr %.99, i64 49)
  %.102 = load ptr, ptr %result, align 8
  %.103 = call ptr @malloc(i64 40)
  %.104 = bitcast ptr %.103 to ptr
  call void @i64.array.init(ptr %.104)
  %left_len.1 = call i64 @i64.array.length(ptr %.99)
  %right_len.1 = call i64 @i64.array.length(ptr %.102)
  %i_left.1 = alloca i64, align 8
  store i64 0, ptr %i_left.1, align 4
  br label %str_concat.left.cond.1

if.false.1:                                       ; preds = %if.false.0
  %.137 = load i64, ptr %d, align 4
  %cmptmp.5 = icmp eq i64 %.137, 2
...
str_concat.left.cond.1:                           ; preds = %str_concat.left.body.1, %if.true.1
  ...
  %.109 = icmp slt i64 %.108, %left_len.1
  br i1 %.109, label %str_concat.left.body.1, label %str_concat.left.end.1

str_concat.left.body.1:                           ; preds = %str_concat.left.cond.1
  %.111 = load i64, ptr %i_left.1, align 4
  %left_char.1 = call i64 @i64.array.get(ptr %.99, i64 %.111)
  call void @i64.array.append(ptr %.104, i64 %left_char.1)
  %.113 = add i64 %.111, 1
  store i64 %.113, ptr %i_left.1, align 4
  br label %str_concat.left.cond.1
...
str_concat.right.cond.1:                          ; preds = %str_concat.right.body.1, %str_concat.left.end.1
  ...
  %.119 = icmp slt i64 %.118, %right_len.1
  br i1 %.119, label %str_concat.right.body.1, label %str_concat.right.end.1

str_concat.right.body.1:                          ; preds = %str_concat.right.cond.1
  %.121 = load i64, ptr %i_right.1, align 4
  %right_char.1 = call i64 @i64.array.get(ptr %.102, i64 %.121)
  call void @i64.array.append(ptr %.104, i64 %right_char.1)
  %.123 = add i64 %.121, 1
  store i64 %.123, ptr %i_right.1, align 4
  br label %str_concat.right.cond.1

str_concat.right.end.1:                           ; preds = %str_concat.right.cond.1
  %.126 = load ptr, ptr %result, align 8
  %.127 = icmp ne ptr %.126, null
  br i1 %.127, label %str_concat.right.end.1.if, label %str_concat.right.end.1.endif

str_concat.right.end.1.if:                        ; preds = %str_concat.right.end.1
  %.129 = icmp eq ptr %.126, null
  br i1 %.129, label %rc_release_continue.3, label %rc_release.3

str_concat.right.end.1.endif:                     ; preds = %rc_release_continue.3, %str_concat.right.end.1
  store ptr %.104, ptr %result, align 8
  br label %if.end.2

rc_release.3:                                     ; preds = %str_concat.right.end.1.if
  %.131 = bitcast ptr %.126 to ptr
  call void @meteor_release(ptr %.131)
  br label %rc_release_continue.3

rc_release_continue.3:                            ; preds = %rc_release.3, %str_concat.right.end.1.if
  br label %str_concat.right.end.1.endif

if.true.2:                                        ; preds = %if.false.1
  %.139 = call ptr @malloc(i64 40)
  %.140 = bitcast ptr %.139 to ptr
  call void @i64.array.init(ptr %.140)
  call void @i64.array.append(ptr %.140, i64 50)
  %.143 = load ptr, ptr %result, align 8
  %.144 = call ptr @malloc(i64 40)
  %.145 = bitcast ptr %.144 to ptr
  call void @i64.array.init(ptr %.145)
  %left_len.2 = call i64 @i64.array.length(ptr %.140)
  %right_len.2 = call i64 @i64.array.length(ptr %.143)
  %i_left.2 = alloca i64, align 8
  store i64 0, ptr %i_left.2, align 4
  br label %str_concat.left.cond.2

if.false.2:                                       ; preds = %if.false.1
  %.178 = load i64, ptr %d, align 4
  %cmptmp.6 = icmp eq i64 %.178, 3
  br i1 %cmptmp.6, label %if.true.3, label %if.false.3

str_concat.left.cond.2:                           ; preds = %str_concat.left.body.2, %if.true.2
  %.149 = load i64, ptr %i_left.2, align 4
  %.150 = icmp slt i64 %.149, %left_len.2
  br i1 %.150, label %str_concat.left.body.2, label %str_concat.left.end.2

str_concat.left.body.2:                           ; preds = %str_concat.left.cond.2
  %.152 = load i64, ptr %i_left.2, align 4
  %left_char.2 = call i64 @i64.array.get(ptr %.140, i64 %.152)
  call void @i64.array.append(ptr %.145, i64 %left_char.2)
  %.154 = add i64 %.152, 1
  store i64 %.154, ptr %i_left.2, align 4
  br label %str_concat.left.cond.2
...
str_concat.right.cond.2:                          ; preds = %str_concat.right.body.2, %str_concat.left.end.2
  %.159 = load i64, ptr %i_right.2, align 4
  %.160 = icmp slt i64 %.159, %right_len.2
  br i1 %.160, label %str_concat.right.body.2, label %str_concat.right.end.2

str_concat.right.body.2:                          ; preds = %str_concat.right.cond.2
  %.162 = load i64, ptr %i_right.2, align 4
  %right_char.2 = call i64 @i64.array.get(ptr %.143, i64 %.162)
  call void @i64.array.append(ptr %.145, i64 %right_char.2)
  %.164 = add i64 %.162, 1
  store i64 %.164, ptr %i_right.2, align 4
  br label %str_concat.right.cond.2

str_concat.right.end.2:                           ; preds = %str_concat.right.cond.2
  %.167 = load ptr, ptr %result, align 8
  %.168 = icmp ne ptr %.167, null
  br i1 %.168, label %str_concat.right.end.2.if, label %str_concat.right.end.2.endif

str_concat.right.end.2.if:                        ; preds = %str_concat.right.end.2
  %.170 = icmp eq ptr %.167, null
  br i1 %.170, label %rc_release_continue.4, label %rc_release.4

str_concat.right.end.2.endif:                     ; preds = %rc_release_continue.4, %str_concat.right.end.2
  store ptr %.145, ptr %result, align 8
  br label %if.end.2

rc_release.4:                                     ; preds = %str_concat.right.end.2.if
  %.172 = bitcast ptr %.167 to ptr
  call void @meteor_release(ptr %.172)
  br label %rc_release_continue.4

rc_release_continue.4:                            ; preds = %rc_release.4, %str_concat.right.end.2.if
  br label %str_concat.right.end.2.endif

if.true.3:                                        ; preds = %if.false.2
  %.180 = call ptr @malloc(i64 40)
  %.181 = bitcast ptr %.180 to ptr
  call void @i64.array.init(ptr %.181)
  call void @i64.array.append(ptr %.181, i64 51)
  %.184 = load ptr, ptr %result, align 8
  %.185 = call ptr @malloc(i64 40)
  %.186 = bitcast ptr %.185 to ptr
  call void @i64.array.init(ptr %.186)
  %left_len.3 = call i64 @i64.array.length(ptr %.181)
  %right_len.3 = call i64 @i64.array.length(ptr %.184)
  %i_left.3 = alloca i64, align 8
  store i64 0, ptr %i_left.3, align 4
  br label %str_concat.left.cond.3

if.false.3:                                       ; preds = %if.false.2
  %.219 = load i64, ptr %d, align 4
  %cmptmp.7 = icmp eq i64 %.219, 4
  br i1 %cmptmp.7, label %if.true.4, label %if.false.4

str_concat.left.cond.3:                           ; preds = %str_concat.left.body.3, %if.true.3
  %.190 = load i64, ptr %i_left.3, align 4
  %.191 = icmp slt i64 %.190, %left_len.3
  br i1 %.191, label %str_concat.left.body.3, label %str_concat.left.end.3

str_concat.left.body.3:                           ; preds = %str_concat.left.cond.3
  %.193 = load i64, ptr %i_left.3, align 4
  %left_char.3 = call i64 @i64.array.get(ptr %.181, i64 %.193)
  call void @i64.array.append(ptr %.186, i64 %left_char.3)
  %.195 = add i64 %.193, 1
  store i64 %.195, ptr %i_left.3, align 4
  br label %str_concat.left.cond.3
...
str_concat.right.cond.3:                          ; preds = %str_concat.right.body.3, %str_concat.left.end.3
  %.200 = load i64, ptr %i_right.3, align 4
  %.201 = icmp slt i64 %.200, %right_len.3
  br i1 %.201, label %str_concat.right.body.3, label %str_concat.right.end.3

str_concat.right.body.3:                          ; preds = %str_concat.right.cond.3
  %.203 = load i64, ptr %i_right.3, align 4
  %right_char.3 = call i64 @i64.array.get(ptr %.184, i64 %.203)
  call void @i64.array.append(ptr %.186, i64 %right_char.3)
  %.205 = add i64 %.203, 1
  store i64 %.205, ptr %i_right.3, align 4
  br label %str_concat.right.cond.3

str_concat.right.end.3:                           ; preds = %str_concat.right.cond.3
  %.208 = load ptr, ptr %result, align 8
  %.209 = icmp ne ptr %.208, null
  br i1 %.209, label %str_concat.right.end.3.if, label %str_concat.right.end.3.endif

str_concat.right.end.3.if:                        ; preds = %str_concat.right.end.3
  %.211 = icmp eq ptr %.208, null
  br i1 %.211, label %rc_release_continue.5, label %rc_release.5

str_concat.right.end.3.endif:                     ; preds = %rc_release_continue.5, %str_concat.right.end.3
  store ptr %.186, ptr %result, align 8
  br label %if.end.2

rc_release.5:                                     ; preds = %str_concat.right.end.3.if
  %.213 = bitcast ptr %.208 to ptr
  call void @meteor_release(ptr %.213)
  br label %rc_release_continue.5

rc_release_continue.5:                            ; preds = %rc_release.5, %str_concat.right.end.3.if
  br label %str_concat.right.end.3.endif

if.true.4:                                        ; preds = %if.false.3
  %.221 = call ptr @malloc(i64 40)
  %.222 = bitcast ptr %.221 to ptr
  call void @i64.array.init(ptr %.222)
  call void @i64.array.append(ptr %.222, i64 52)
  %.225 = load ptr, ptr %result, align 8
  %.226 = call ptr @malloc(i64 40)
  %.227 = bitcast ptr %.226 to ptr
  call void @i64.array.init(ptr %.227)
  %left_len.4 = call i64 @i64.array.length(ptr %.222)
  %right_len.4 = call i64 @i64.array.length(ptr %.225)
  %i_left.4 = alloca i64, align 8
  store i64 0, ptr %i_left.4, align 4
  br label %str_concat.left.cond.4

if.false.4:                                       ; preds = %if.false.3
  %.260 = load i64, ptr %d, align 4
  %cmptmp.8 = icmp eq i64 %.260, 5
  br i1 %cmptmp.8, label %if.true.5, label %if.false.5

str_concat.left.cond.4:                           ; preds = %str_concat.left.body.4, %if.true.4
  %.231 = load i64, ptr %i_left.4, align 4
  %.232 = icmp slt i64 %.231, %left_len.4
  br i1 %.232, label %str_concat.left.body.4, label %str_concat.left.end.4

str_concat.left.body.4:                           ; preds = %str_concat.left.cond.4
  %.234 = load i64, ptr %i_left.4, align 4
  %left_char.4 = call i64 @i64.array.get(ptr %.222, i64 %.234)
  call void @i64.array.append(ptr %.227, i64 %left_char.4)
  %.236 = add i64 %.234, 1
  store i64 %.236, ptr %i_left.4, align 4
  br label %str_concat.left.cond.4
...
str_concat.right.cond.4:                          ; preds = %str_concat.right.body.4, %str_concat.left.end.4
  %.241 = load i64, ptr %i_right.4, align 4
  %.242 = icmp slt i64 %.241, %right_len.4
  br i1 %.242, label %str_concat.right.body.4, label %str_concat.right.end.4

str_concat.right.body.4:                          ; preds = %str_concat.right.cond.4
  %.244 = load i64, ptr %i_right.4, align 4
  %right_char.4 = call i64 @i64.array.get(ptr %.225, i64 %.244)
  call void @i64.array.append(ptr %.227, i64 %right_char.4)
  %.246 = add i64 %.244, 1
  store i64 %.246, ptr %i_right.4, align 4
  br label %str_concat.right.cond.4

str_concat.right.end.4:                           ; preds = %str_concat.right.cond.4
  %.249 = load ptr, ptr %result, align 8
  %.250 = icmp ne ptr %.249, null
  br i1 %.250, label %str_concat.right.end.4.if, label %str_concat.right.end.4.endif

str_concat.right.end.4.if:                        ; preds = %str_concat.right.end.4
  %.252 = icmp eq ptr %.249, null
  br i1 %.252, label %rc_release_continue.6, label %rc_release.6

str_concat.right.end.4.endif:                     ; preds = %rc_release_continue.6, %str_concat.right.end.4
  store ptr %.227, ptr %result, align 8
  br label %if.end.2

rc_release.6:                                     ; preds = %str_concat.right.end.4.if
  %.254 = bitcast ptr %.249 to ptr
  call void @meteor_release(ptr %.254)
  br label %rc_release_continue.6

rc_release_continue.6:                            ; preds = %rc_release.6, %str_concat.right.end.4.if
  br label %str_concat.right.end.4.endif

if.true.5:                                        ; preds = %if.false.4
  %.262 = call ptr @malloc(i64 40)
  %.263 = bitcast ptr %.262 to ptr
  call void @i64.array.init(ptr %.263)
  call void @i64.array.append(ptr %.263, i64 53)
  %.266 = load ptr, ptr %result, align 8
  %.267 = call ptr @malloc(i64 40)
  %.268 = bitcast ptr %.267 to ptr
  call void @i64.array.init(ptr %.268)
  %left_len.5 = call i64 @i64.array.length(ptr %.263)
  %right_len.5 = call i64 @i64.array.length(ptr %.266)
  %i_left.5 = alloca i64, align 8
  store i64 0, ptr %i_left.5, align 4
  br label %str_concat.left.cond.5

if.false.5:                                       ; preds = %if.false.4
  %.301 = load i64, ptr %d, align 4
  %cmptmp.9 = icmp eq i64 %.301, 6
  br i1 %cmptmp.9, label %if.true.6, label %if.false.6

str_concat.left.cond.5:                           ; preds = %str_concat.left.body.5, %if.true.5
  %.272 = load i64, ptr %i_left.5, align 4
  %.273 = icmp slt i64 %.272, %left_len.5
  br i1 %.273, label %str_concat.left.body.5, label %str_concat.left.end.5

str_concat.left.body.5:                           ; preds = %str_concat.left.cond.5
  %.275 = load i64, ptr %i_left.5, align 4
  %left_char.5 = call i64 @i64.array.get(ptr %.263, i64 %.275)
  call void @i64.array.append(ptr %.268, i64 %left_char.5)
  %.277 = add i64 %.275, 1
  store i64 %.277, ptr %i_left.5, align 4
  br label %str_concat.left.cond.5
...
str_concat.right.cond.5:                          ; preds = %str_concat.right.body.5, %str_concat.left.end.5
  %.282 = load i64, ptr %i_right.5, align 4
  %.283 = icmp slt i64 %.282, %right_len.5
  br i1 %.283, label %str_concat.right.body.5, label %str_concat.right.end.5

str_concat.right.body.5:                          ; preds = %str_concat.right.cond.5
  %.285 = load i64, ptr %i_right.5, align 4
  %right_char.5 = call i64 @i64.array.get(ptr %.266, i64 %.285)
  call void @i64.array.append(ptr %.268, i64 %right_char.5)
  %.287 = add i64 %.285, 1
  store i64 %.287, ptr %i_right.5, align 4
  br label %str_concat.right.cond.5

str_concat.right.end.5:                           ; preds = %str_concat.right.cond.5
  %.290 = load ptr, ptr %result, align 8
  %.291 = icmp ne ptr %.290, null
  br i1 %.291, label %str_concat.right.end.5.if, label %str_concat.right.end.5.endif

str_concat.right.end.5.if:                        ; preds = %str_concat.right.end.5
  %.293 = icmp eq ptr %.290, null
  br i1 %.293, label %rc_release_continue.7, label %rc_release.7

str_concat.right.end.5.endif:                     ; preds = %rc_release_continue.7, %str_concat.right.end.5
  store ptr %.268, ptr %result, align 8
  br label %if.end.2

rc_release.7:                                     ; preds = %str_concat.right.end.5.if
  %.295 = bitcast ptr %.290 to ptr
  call void @meteor_release(ptr %.295)
  br label %rc_release_continue.7

rc_release_continue.7:                            ; preds = %rc_release.7, %str_concat.right.end.5.if
  br label %str_concat.right.end.5.endif

if.true.6:                                        ; preds = %if.false.5
  %.303 = call ptr @malloc(i64 40)
  %.304 = bitcast ptr %.303 to ptr
  call void @i64.array.init(ptr %.304)
  call void @i64.array.append(ptr %.304, i64 54)
  %.307 = load ptr, ptr %result, align 8
  %.308 = call ptr @malloc(i64 40)
  %.309 = bitcast ptr %.308 to ptr
  call void @i64.array.init(ptr %.309)
  %left_len.6 = call i64 @i64.array.length(ptr %.304)
  %right_len.6 = call i64 @i64.array.length(ptr %.307)
  %i_left.6 = alloca i64, align 8
  store i64 0, ptr %i_left.6, align 4
  br label %str_concat.left.cond.6

if.false.6:                                       ; preds = %if.false.5
  %.342 = load i64, ptr %d, align 4
  %cmptmp.10 = icmp eq i64 %.342, 7
  br i1 %cmptmp.10, label %if.true.7, label %if.false.7

str_concat.left.cond.6:                           ; preds = %str_concat.left.body.6, %if.true.6
  %.313 = load i64, ptr %i_left.6, align 4
  %.314 = icmp slt i64 %.313, %left_len.6
  br i1 %.314, label %str_concat.left.body.6, label %str_concat.left.end.6

str_concat.left.body.6:                           ; preds = %str_concat.left.cond.6
  %.316 = load i64, ptr %i_left.6, align 4
  %left_char.6 = call i64 @i64.array.get(ptr %.304, i64 %.316)
  call void @i64.array.append(ptr %.309, i64 %left_char.6)
  %.318 = add i64 %.316, 1
  store i64 %.318, ptr %i_left.6, align 4
  br label %str_concat.left.cond.6
...
str_concat.right.cond.6:                          ; preds = %str_concat.right.body.6, %str_concat.left.end.6
  %.323 = load i64, ptr %i_right.6, align 4
  %.324 = icmp slt i64 %.323, %right_len.6
  br i1 %.324, label %str_concat.right.body.6, label %str_concat.right.end.6

str_concat.right.body.6:                          ; preds = %str_concat.right.cond.6
  %.326 = load i64, ptr %i_right.6, align 4
  %right_char.6 = call i64 @i64.array.get(ptr %.307, i64 %.326)
  call void @i64.array.append(ptr %.309, i64 %right_char.6)
  %.328 = add i64 %.326, 1
  store i64 %.328, ptr %i_right.6, align 4
  br label %str_concat.right.cond.6

str_concat.right.end.6:                           ; preds = %str_concat.right.cond.6
  %.331 = load ptr, ptr %result, align 8
  %.332 = icmp ne ptr %.331, null
  br i1 %.332, label %str_concat.right.end.6.if, label %str_concat.right.end.6.endif

str_concat.right.end.6.if:                        ; preds = %str_concat.right.end.6
  %.334 = icmp eq ptr %.331, null
  br i1 %.334, label %rc_release_continue.8, label %rc_release.8

str_concat.right.end.6.endif:                     ; preds = %rc_release_continue.8, %str_concat.right.end.6
  store ptr %.309, ptr %result, align 8
  br label %if.end.2

rc_release.8:                                     ; preds = %str_concat.right.end.6.if
  %.336 = bitcast ptr %.331 to ptr
  call void @meteor_release(ptr %.336)
  br label %rc_release_continue.8

rc_release_continue.8:                            ; preds = %rc_release.8, %str_concat.right.end.6.if
  br label %str_concat.right.end.6.endif

if.true.7:                                        ; preds = %if.false.6
  %.344 = call ptr @malloc(i64 40)
  %.345 = bitcast ptr %.344 to ptr
  call void @i64.array.init(ptr %.345)
  call void @i64.array.append(ptr %.345, i64 55)
  %.348 = load ptr, ptr %result, align 8
  %.349 = call ptr @malloc(i64 40)
  %.350 = bitcast ptr %.349 to ptr
  call void @i64.array.init(ptr %.350)
  %left_len.7 = call i64 @i64.array.length(ptr %.345)
  %right_len.7 = call i64 @i64.array.length(ptr %.348)
  %i_left.7 = alloca i64, align 8
  store i64 0, ptr %i_left.7, align 4
  br label %str_concat.left.cond.7

if.false.7:                                       ; preds = %if.false.6
  %.383 = load i64, ptr %d, align 4
  %cmptmp.11 = icmp eq i64 %.383, 8
  br i1 %cmptmp.11, label %if.true.8, label %if.false.8

str_concat.left.cond.7:                           ; preds = %str_concat.left.body.7, %if.true.7
  %.354 = load i64, ptr %i_left.7, align 4
  %.355 = icmp slt i64 %.354, %left_len.7
  br i1 %.355, label %str_concat.left.body.7, label %str_concat.left.end.7

str_concat.left.body.7:                           ; preds = %str_concat.left.cond.7
  %.357 = load i64, ptr %i_left.7, align 4
  %left_char.7 = call i64 @i64.array.get(ptr %.345, i64 %.357)
  call void @i64.array.append(ptr %.350, i64 %left_char.7)
  %.359 = add i64 %.357, 1
  store i64 %.359, ptr %i_left.7, align 4
  br label %str_concat.left.cond.7
...
str_concat.right.cond.7:                          ; preds = %str_concat.right.body.7, %str_concat.left.end.7
  %.364 = load i64, ptr %i_right.7, align 4
  %.365 = icmp slt i64 %.364, %right_len.7
  br i1 %.365, label %str_concat.right.body.7, label %str_concat.right.end.7

str_concat.right.body.7:                          ; preds = %str_concat.right.cond.7
  %.367 = load i64, ptr %i_right.7, align 4
  %right_char.7 = call i64 @i64.array.get(ptr %.348, i64 %.367)
  call void @i64.array.append(ptr %.350, i64 %right_char.7)
  %.369 = add i64 %.367, 1
  store i64 %.369, ptr %i_right.7, align 4
  br label %str_concat.right.cond.7

str_concat.right.end.7:                           ; preds = %str_concat.right.cond.7
  %.372 = load ptr, ptr %result, align 8
  %.373 = icmp ne ptr %.372, null
  br i1 %.373, label %str_concat.right.end.7.if, label %str_concat.right.end.7.endif

str_concat.right.end.7.if:                        ; preds = %str_concat.right.end.7
  %.375 = icmp eq ptr %.372, null
  br i1 %.375, label %rc_release_continue.9, label %rc_release.9

str_concat.right.end.7.endif:                     ; preds = %rc_release_continue.9, %str_concat.right.end.7
  store ptr %.350, ptr %result, align 8
  br label %if.end.2

rc_release.9:                                     ; preds = %str_concat.right.end.7.if
  %.377 = bitcast ptr %.372 to ptr
  call void @meteor_release(ptr %.377)
  br label %rc_release_continue.9

rc_release_continue.9:                            ; preds = %rc_release.9, %str_concat.right.end.7.if
  br label %str_concat.right.end.7.endif

if.true.8:                                        ; preds = %if.false.7
  %.385 = call ptr @malloc(i64 40)
  %.386 = bitcast ptr %.385 to ptr
  call void @i64.array.init(ptr %.386)
  call void @i64.array.append(ptr %.386, i64 56)
  %.389 = load ptr, ptr %result, align 8
  %.390 = call ptr @malloc(i64 40)
  %.391 = bitcast ptr %.390 to ptr
  call void @i64.array.init(ptr %.391)
  %left_len.8 = call i64 @i64.array.length(ptr %.386)
  %right_len.8 = call i64 @i64.array.length(ptr %.389)
...
str_concat.left.cond.8:                           ; preds = %str_concat.left.body.8, %if.true.8
  %.395 = load i64, ptr %i_left.8, align 4
  %.396 = icmp slt i64 %.395, %left_len.8
  br i1 %.396, label %str_concat.left.body.8, label %str_concat.left.end.8

str_concat.left.body.8:                           ; preds = %str_concat.left.cond.8
  %.398 = load i64, ptr %i_left.8, align 4
  %left_char.8 = call i64 @i64.array.get(ptr %.386, i64 %.398)
  call void @i64.array.append(ptr %.391, i64 %left_char.8)
  %.400 = add i64 %.398, 1
  store i64 %.400, ptr %i_left.8, align 4
  br label %str_concat.left.cond.8
...
str_concat.right.cond.8:                          ; preds = %str_concat.right.body.8, %str_concat.left.end.8
  %.405 = load i64, ptr %i_right.8, align 4
  %.406 = icmp slt i64 %.405, %right_len.8
  br i1 %.406, label %str_concat.right.body.8, label %str_concat.right.end.8

str_concat.right.body.8:                          ; preds = %str_concat.right.cond.8
  %.408 = load i64, ptr %i_right.8, align 4
  %right_char.8 = call i64 @i64.array.get(ptr %.389, i64 %.408)
  call void @i64.array.append(ptr %.391, i64 %right_char.8)
  %.410 = add i64 %.408, 1
  store i64 %.410, ptr %i_right.8, align 4
  br label %str_concat.right.cond.8

str_concat.right.end.8:                           ; preds = %str_concat.right.cond.8
  %.413 = load ptr, ptr %result, align 8
  %.414 = icmp ne ptr %.413, null
  br i1 %.414, label %str_concat.right.end.8.if, label %str_concat.right.end.8.endif

str_concat.right.end.8.if:                        ; preds = %str_concat.right.end.8
  %.416 = icmp eq ptr %.413, null
  br i1 %.416, label %rc_release_continue.10, label %rc_release.10

str_concat.right.end.8.endif:                     ; preds = %rc_release_continue.10, %str_concat.right.end.8
  store ptr %.391, ptr %result, align 8
  br label %if.end.2

rc_release.10:                                    ; preds = %str_concat.right.end.8.if
  %.418 = bitcast ptr %.413 to ptr
  call void @meteor_release(ptr %.418)
  br label %rc_release_continue.10

rc_release_continue.10:                           ; preds = %rc_release.10, %str_concat.right.end.8.if
  br label %str_concat.right.end.8.endif

if.true.9:                                        ; preds = %if.false.8
  %.425 = call ptr @malloc(i64 40)
  %.426 = bitcast ptr %.425 to ptr
  call void @i64.array.init(ptr %.426)
  call void @i64.array.append(ptr %.426, i64 57)
  %.429 = load ptr, ptr %result, align 8
  %.430 = call ptr @malloc(i64 40)
  %.431 = bitcast ptr %.430 to ptr
  call void @i64.array.init(ptr %.431)
  %left_len.9 = call i64 @i64.array.length(ptr %.426)
  %right_len.9 = call i64 @i64.array.length(ptr %.429)
...
str_concat.left.cond.9:                           ; preds = %str_concat.left.body.9, %if.true.9
  %.435 = load i64, ptr %i_left.9, align 4
  %.436 = icmp slt i64 %.435, %left_len.9
  br i1 %.436, label %str_concat.left.body.9, label %str_concat.left.end.9

str_concat.left.body.9:                           ; preds = %str_concat.left.cond.9
  %.438 = load i64, ptr %i_left.9, align 4
  %left_char.9 = call i64 @i64.array.get(ptr %.426, i64 %.438)
  call void @i64.array.append(ptr %.431, i64 %left_char.9)
  %.440 = add i64 %.438, 1
  store i64 %.440, ptr %i_left.9, align 4
  br label %str_concat.left.cond.9
...
str_concat.right.cond.9:                          ; preds = %str_concat.right.body.9, %str_concat.left.end.9
  %.445 = load i64, ptr %i_right.9, align 4
  %.446 = icmp slt i64 %.445, %right_len.9
  br i1 %.446, label %str_concat.right.body.9, label %str_concat.right.end.9

str_concat.right.body.9:                          ; preds = %str_concat.right.cond.9
  %.448 = load i64, ptr %i_right.9, align 4
  %right_char.9 = call i64 @i64.array.get(ptr %.429, i64 %.448)
  call void @i64.array.append(ptr %.431, i64 %right_char.9)
  %.450 = add i64 %.448, 1
  store i64 %.450, ptr %i_right.9, align 4
  br label %str_concat.right.cond.9

str_concat.right.end.9:                           ; preds = %str_concat.right.cond.9
  %.453 = load ptr, ptr %result, align 8
  %.454 = icmp ne ptr %.453, null
  br i1 %.454, label %str_concat.right.end.9.if, label %str_concat.right.end.9.endif

str_concat.right.end.9.if:                        ; preds = %str_concat.right.end.9
  %.456 = icmp eq ptr %.453, null
  br i1 %.456, label %rc_release_continue.11, label %rc_release.11

str_concat.right.end.9.endif:                     ; preds = %rc_release_continue.11, %str_concat.right.end.9
  store ptr %.431, ptr %result, align 8
  br label %if.end.2

rc_release.11:                                    ; preds = %str_concat.right.end.9.if
  %.458 = bitcast ptr %.453 to ptr
  call void @meteor_release(ptr %.458)
  br label %rc_release_continue.11

rc_release_continue.11:                           ; preds = %rc_release.11, %str_concat.right.end.9.if
  br label %str_concat.right.end.9.endif

if.start.3:                                       ; preds = %while.end
  %.471 = load i1, ptr %is_neg, align 1
  br i1 %.471, label %if.true.0.3, label %if.end.3

if.end.3:                                         ; preds = %str_concat.right.end.10.endif, %if.start.3
  %.512 = load ptr, ptr %result, align 8
  %.513 = load ptr, ptr %ret_var, align 8
  %.514 = icmp ne ptr %.513, null
  br i1 %.514, label %if.end.3.if, label %if.end.3.endif

if.true.0.3:                                      ; preds = %if.start.3
  %.473 = call ptr @malloc(i64 40)
  %.474 = bitcast ptr %.473 to ptr
  call void @i64.array.init(ptr %.474)
  call void @i64.array.append(ptr %.474, i64 45)
  %.477 = load ptr, ptr %result, align 8
  %.478 = call ptr @malloc(i64 40)
  %.479 = bitcast ptr %.478 to ptr
  call void @i64.array.init(ptr %.479)
  %left_len.10 = call i64 @i64.array.length(ptr %.474)
  %right_len.10 = call i64 @i64.array.length(ptr %.477)
...
str_concat.left.cond.10:                          ; preds = %str_concat.left.body.10, %if.true.0.3
  %.483 = load i64, ptr %i_left.10, align 4
  %.484 = icmp slt i64 %.483, %left_len.10
  br i1 %.484, label %str_concat.left.body.10, label %str_concat.left.end.10

str_concat.left.body.10:                          ; preds = %str_concat.left.cond.10
  %.486 = load i64, ptr %i_left.10, align 4
  %left_char.10 = call i64 @i64.array.get(ptr %.474, i64 %.486)
  call void @i64.array.append(ptr %.479, i64 %left_char.10)
  %.488 = add i64 %.486, 1
  store i64 %.488, ptr %i_left.10, align 4
  br label %str_concat.left.cond.10
...
str_concat.right.cond.10:                         ; preds = %str_concat.right.body.10, %str_concat.left.end.10
  %.493 = load i64, ptr %i_right.10, align 4
  %.494 = icmp slt i64 %.493, %right_len.10
  br i1 %.494, label %str_concat.right.body.10, label %str_concat.right.end.10

str_concat.right.body.10:                         ; preds = %str_concat.right.cond.10
  %.496 = load i64, ptr %i_right.10, align 4
  %right_char.10 = call i64 @i64.array.get(ptr %.477, i64 %.496)
  call void @i64.array.append(ptr %.479, i64 %right_char.10)
  %.498 = add i64 %.496, 1
  store i64 %.498, ptr %i_right.10, align 4
  br label %str_concat.right.cond.10

str_concat.right.end.10:                          ; preds = %str_concat.right.cond.10
  %.501 = load ptr, ptr %result, align 8
  %.502 = icmp ne ptr %.501, null
  br i1 %.502, label %str_concat.right.end.10.if, label %str_concat.right.end.10.endif

str_concat.right.end.10.if:                       ; preds = %str_concat.right.end.10
  %.504 = icmp eq ptr %.501, null
  br i1 %.504, label %rc_release_continue.12, label %rc_release.12

str_concat.right.end.10.endif:                    ; preds = %rc_release_continue.12, %str_concat.right.end.10
  store ptr %.479, ptr %result, align 8
  br label %if.end.3

rc_release.12:                                    ; preds = %str_concat.right.end.10.if
  %.506 = bitcast ptr %.501 to ptr
  call void @meteor_release(ptr %.506)
  br label %rc_release_continue.12

rc_release_continue.12:                           ; preds = %rc_release.12, %str_concat.right.end.10.if
  br label %str_concat.right.end.10.endif

if.end.3.if:                                      ; preds = %if.end.3
  %.516 = icmp eq ptr %.513, null
  br i1 %.516, label %rc_release_continue.13, label %rc_release.13

if.end.3.endif:                                   ; preds = %rc_release_continue.13, %if.end.3
  store ptr %.512, ptr %ret_var, align 8
  %.523 = bitcast ptr %.512 to ptr
  call void @meteor_retain(ptr %.523)
  %.525 = load ptr, ptr %result, align 8
  %.526 = icmp eq ptr %.525, null
  br i1 %.526, label %rc_release_continue.14, label %rc_release.14

rc_release.13:                                    ; preds = %if.end.3.if
  %.518 = bitcast ptr %.513 to ptr
  call void @meteor_release(ptr %.518)
  br label %rc_release_continue.13

rc_release_continue.13:                           ; preds = %rc_release.13, %if.end.3.if
  br label %if.end.3.endif

rc_release.14:                                    ; preds = %if.end.3.endif
  %.528 = bitcast ptr %.525 to ptr
  call void @meteor_release(ptr %.528)
  br label %rc_release_continue.14

rc_release_continue.14:                           ; preds = %rc_release.14, %if.end.3.endif
  br label %exit
}
...
rc_release:                                       ; preds = %entry.if
  ...
  %.41 = getelementptr i8, ptr %.40, i64 -16
  %.42 = bitcast ptr %.41 to ptr
  %.43 = getelementptr %meteor.header, ptr %.42, i64 0, i32 0
  %.44 = load i32, ptr %.43, align 4
  %.45 = icmp eq i32 %.44, 1
  br i1 %.45, label %rc_destroy, label %rc_release_only
...
exit:                                             ; preds = %rc_release_continue.4
  %.197 = load ptr, ptr %ret_var, align 8
  ret ptr %.197
...
str_concat.left.cond:                             ; preds = %str_concat.left.body, %entry.endif
  %.45 = load i64, ptr %i_left, align 4
  %.46 = icmp slt i64 %.45, %left_len
  br i1 %.46, label %str_concat.left.body, label %str_concat.left.end

str_concat.left.body:                             ; preds = %str_concat.left.cond
  %.48 = load i64, ptr %i_left, align 4
  %left_char = call i64 @i64.array.get(ptr %.23, i64 %.48)
  call void @i64.array.append(ptr %.41, i64 %left_char)
  %.50 = add i64 %.48, 1
  store i64 %.50, ptr %i_left, align 4
  br label %str_concat.left.cond
...
str_concat.right.cond:                            ; preds = %str_concat.right.body, %str_concat.left.end
  %.55 = load i64, ptr %i_right, align 4
  %.56 = icmp slt i64 %.55, %right_len
  br i1 %.56, label %str_concat.right.body, label %str_concat.right.end

str_concat.right.body:                            ; preds = %str_concat.right.cond
  %.58 = load i64, ptr %i_right, align 4
  %right_char = call i64 @i64.array.get(ptr %.39, i64 %.58)
  call void @i64.array.append(ptr %.41, i64 %right_char)
  %.60 = add i64 %.58, 1
  store i64 %.60, ptr %i_right, align 4
  br label %str_concat.right.cond
...
str_concat.right.end:                             ; preds = %str_concat.right.cond
  ...
  %.64 = bitcast ptr %.63 to ptr
  call void @i64.array.init(ptr %.64)
  call void @i64.array.append(ptr %.64, i64 44)
  call void @i64.array.append(ptr %.64, i64 32)
  call void @i64.array.append(ptr %.64, i64 34)
  call void @i64.array.append(ptr %.64, i64 109)
  call void @i64.array.append(ptr %.64, i64 101)
  call void @i64.array.append(ptr %.64, i64 115)
  call void @i64.array.append(ptr %.64, i64 115)
  call void @i64.array.append(ptr %.64, i64 97)
  call void @i64.array.append(ptr %.64, i64 103)
  call void @i64.array.append(ptr %.64, i64 101)
  call void @i64.array.append(ptr %.64, i64 34)
  call void @i64.array.append(ptr %.64, i64 58)
  call void @i64.array.append(ptr %.64, i64 32)
  call void @i64.array.append(ptr %.64, i64 34)
  call void @i64.array.append(ptr %.64, i64 67)
  call void @i64.array.append(ptr %.64, i64 117)
  call void @i64.array.append(ptr %.64, i64 114)
  call void @i64.array.append(ptr %.64, i64 114)
  call void @i64.array.append(ptr %.64, i64 101)
  call void @i64.array.append(ptr %.64, i64 110)
  call void @i64.array.append(ptr %.64, i64 116)
  call void @i64.array.append(ptr %.64, i64 32)
  call void @i64.array.append(ptr %.64, i64 115)
  call void @i64.array.append(ptr %.64, i64 101)
  call void @i64.array.append(ptr %.64, i64 114)
  call void @i64.array.append(ptr %.64, i64 118)
  call void @i64.array.append(ptr %.64, i64 101)
  call void @i64.array.append(ptr %.64, i64 114)
  call void @i64.array.append(ptr %.64, i64 32)
  call void @i64.array.append(ptr %.64, i64 116)
  call void @i64.array.append(ptr %.64, i64 105)
  call void @i64.array.append(ptr %.64, i64 109)
  call void @i64.array.append(ptr %.64, i64 101)
  call void @i64.array.append(ptr %.64, i64 32)
  call void @i64.array.append(ptr %.64, i64 40)
  call void @i64.array.append(ptr %.64, i64 85)
  call void @i64.array.append(ptr %.64, i64 110)
  call void @i64.array.append(ptr %.64, i64 105)
  call void @i64.array.append(ptr %.64, i64 120)
  call void @i64.array.append(ptr %.64, i64 32)
  call void @i64.array.append(ptr %.64, i64 116)
  call void @i64.array.append(ptr %.64, i64 105)
  call void @i64.array.append(ptr %.64, i64 109)
  ...
  call void @i64.array.append(ptr %.64, i64 97)
  call void @i64.array.append(ptr %.64, i64 109)
  call void @i64.array.append(ptr %.64, i64 112)
  call void @i64.array.append(ptr %.64, i64 41)
  call void @i64.array.append(ptr %.64, i64 34)
  call void @i64.array.append(ptr %.64, i64 125)
  %.118 = call ptr @malloc(i64 40)
  %.119 = bitcast ptr %.118 to ptr
  call void @i64.array.init(ptr %.119)
  %left_len.1 = call i64 @i64.array.length(ptr %.41)
  %right_len.1 = call i64 @i64.array.length(ptr %.64)
  %i_left.1 = alloca i64, align 8
  store i64 0, ptr %i_left.1, align 4
  br label %str_concat.left.cond.1

str_concat.left.cond.1:                           ; preds = %str_concat.left.body.1, %str_concat.right.end
  %.123 = load i64, ptr %i_left.1, align 4
  %.124 = icmp slt i64 %.123, %left_len.1
  br i1 %.124, label %str_concat.left.body.1, label %str_concat.left.end.1

str_concat.left.body.1:                           ; preds = %str_concat.left.cond.1
  %.126 = load i64, ptr %i_left.1, align 4
  %left_char.1 = call i64 @i64.array.get(ptr %.41, i64 %.126)
  call void @i64.array.append(ptr %.119, i64 %left_char.1)
  %.128 = add i64 %.126, 1
  store i64 %.128, ptr %i_left.1, align 4
  br label %str_concat.left.cond.1
...
str_concat.right.cond.1:                          ; preds = %str_concat.right.body.1, %str_concat.left.end.1
  %.133 = load i64, ptr %i_right.1, align 4
  %.134 = icmp slt i64 %.133, %right_len.1
  br i1 %.134, label %str_concat.right.body.1, label %str_concat.right.end.1

str_concat.right.body.1:                          ; preds = %str_concat.right.cond.1
  %.136 = load i64, ptr %i_right.1, align 4
  %right_char.1 = call i64 @i64.array.get(ptr %.64, i64 %.136)
  call void @i64.array.append(ptr %.119, i64 %right_char.1)
  %.138 = add i64 %.136, 1
  store i64 %.138, ptr %i_right.1, align 4
  br label %str_concat.right.cond.1

str_concat.right.end.1:                           ; preds = %str_concat.right.cond.1
  %.142 = load ptr, ptr %json_data, align 8
  %.143 = icmp ne ptr %.142, null
  br i1 %.143, label %str_concat.right.end.1.if, label %str_concat.right.end.1.endif

str_concat.right.end.1.if:                        ; preds = %str_concat.right.end.1
  %.145 = icmp eq ptr %.142, null
  br i1 %.145, label %rc_release_continue.1, label %rc_release.1

str_concat.right.end.1.endif:                     ; preds = %rc_release_continue.1, %str_concat.right.end.1
  store ptr %.119, ptr %json_data, align 8
  %.152 = load ptr, ptr %res.1, align 8
  %.153 = load ptr, ptr %json_data, align 8
  %.154 = call ptr @Response.json(ptr %.152, ptr %.153)
  %.155 = load ptr, ptr %ret_var, align 8
  %.156 = icmp ne ptr %.155, null
  br i1 %.156, label %str_concat.right.end.1.endif.if, label %str_concat.right.end.1.endif.endif

rc_release.1:                                     ; preds = %str_concat.right.end.1.if
  %.147 = bitcast ptr %.142 to ptr
  call void @meteor_release(ptr %.147)
  br label %rc_release_continue.1

rc_release_continue.1:                            ; preds = %rc_release.1, %str_concat.right.end.1.if
  br label %str_concat.right.end.1.endif

str_concat.right.end.1.endif.if:                  ; preds = %str_concat.right.end.1.endif
  %.158 = icmp eq ptr %.155, null
  br i1 %.158, label %rc_release_continue.2, label %rc_release.2

str_concat.right.end.1.endif.endif:               ; preds = %rc_release_continue.2, %str_concat.right.end.1.endif
  store ptr %.154, ptr %ret_var, align 8
  %.180 = bitcast ptr %.154 to ptr
  %.181 = getelementptr i8, ptr %.180, i64 -16
  %.182 = bitcast ptr %.181 to ptr
  call void @meteor_retain(ptr %.182)
  %.184 = load ptr, ptr %ts_str, align 8
  %.185 = icmp eq ptr %.184, null
  br i1 %.185, label %rc_release_continue.3, label %rc_release.3

rc_release.2:                                     ; preds = %str_concat.right.end.1.endif.if
  %.160 = bitcast ptr %.155 to ptr
  %.161 = getelementptr i8, ptr %.160, i64 -16
  %.162 = bitcast ptr %.161 to ptr
  %.163 = getelementptr %meteor.header, ptr %.162, i64 0, i32 0
  %.164 = load i32, ptr %.163, align 4
  %.165 = icmp eq i32 %.164, 1
  br i1 %.165, label %rc_destroy, label %rc_release_only

rc_release_continue.2:                            ; preds = %rc_release_only, %rc_destroy, %str_concat.right.end.1.endif.if
  br label %str_concat.right.end.1.endif.endif

rc_destroy:                                       ; preds = %rc_release.2
  call void @__destroy_Response__(ptr %.155)
  %.168 = bitcast ptr %.155 to ptr
  %.169 = getelementptr i8, ptr %.168, i64 -16
  %.170 = bitcast ptr %.169 to ptr
  call void @meteor_release(ptr %.170)
  br label %rc_release_continue.2

rc_release_only:                                  ; preds = %rc_release.2
  %.173 = bitcast ptr %.155 to ptr
  %.174 = getelementptr i8, ptr %.173, i64 -16
  %.175 = bitcast ptr %.174 to ptr
  call void @meteor_release(ptr %.175)
  br label %rc_release_continue.2

rc_release.3:                                     ; preds = %str_concat.right.end.1.endif.endif
  %.187 = bitcast ptr %.184 to ptr
  call void @meteor_release(ptr %.187)
  br label %rc_release_continue.3

rc_release_continue.3:                            ; preds = %rc_release.3, %str_concat.right.end.1.endif.endif
  %.190 = load ptr, ptr %json_data, align 8
  %.191 = icmp eq ptr %.190, null
  br i1 %.191, label %rc_release_continue.4, label %rc_release.4

rc_release.4:                                     ; preds = %rc_release_continue.3
  %.193 = bitcast ptr %.190 to ptr
  call void @meteor_release(ptr %.193)
  br label %rc_release_continue.4
...
exit:                                             ; preds = %entry.endif
  %.378 = load ptr, ptr %server, align 8
  %.379 = icmp eq ptr %.378, null
  br i1 %.379, label %rc_release_continue.1, label %rc_release.1
...
entry.endif:                                      ; preds = %rc_release_continue, %entry
  ...
  %.161 = load ptr, ptr %server, align 8
  %.162 = call ptr @malloc(i64 40)
  %.163 = bitcast ptr %.162 to ptr
  call void @i64.array.init(ptr %.163)
  call void @i64.array.append(ptr %.163, i64 47)
  %.166 = call ptr @Server.get(ptr %.161, ptr %.163, ptr @home_handler)
  ...
  call void @i64.array.append(ptr %.169, i64 104)
  call void @i64.array.append(ptr %.169, i64 101)
  call void @i64.array.append(ptr %.169, i64 108)
  call void @i64.array.append(ptr %.169, i64 108)
  call void @i64.array.append(ptr %.169, i64 111)
  %.177 = call ptr @Server.get(ptr %.167, ptr %.169, ptr @hello_handler)
  %.178 = load ptr, ptr %server, align 8
  %.179 = call ptr @malloc(i64 40)
  %.180 = bitcast ptr %.179 to ptr
  call void @i64.array.init(ptr %.180)
  call void @i64.array.append(ptr %.180, i64 47)
  call void @i64.array.append(ptr %.180, i64 97)
  call void @i64.array.append(ptr %.180, i64 112)
  call void @i64.array.append(ptr %.180, i64 105)
  call void @i64.array.append(ptr %.180, i64 47)
  call void @i64.array.append(ptr %.180, i64 105)
  call void @i64.array.append(ptr %.180, i64 110)
  call void @i64.array.append(ptr %.180, i64 102)
  call void @i64.array.append(ptr %.180, i64 111)
  %.191 = call ptr @Server.get(ptr %.178, ptr %.180, ptr @api_info_handler)
  %.192 = load ptr, ptr %server, align 8
  %.193 = call ptr @malloc(i64 40)
  %.194 = bitcast ptr %.193 to ptr
  call void @i64.array.init(ptr %.194)
  call void @i64.array.append(ptr %.194, i64 47)
  call void @i64.array.append(ptr %.194, i64 97)
  call void @i64.array.append(ptr %.194, i64 112)
  call void @i64.array.append(ptr %.194, i64 105)
  call void @i64.array.append(ptr %.194, i64 47)
  call void @i64.array.append(ptr %.194, i64 116)
  call void @i64.array.append(ptr %.194, i64 105)
  call void @i64.array.append(ptr %.194, i64 109)
  call void @i64.array.append(ptr %.194, i64 101)
  %.205 = call ptr @Server.get(ptr %.192, ptr %.194, ptr @api_time_handler)
  %.206 = call ptr @malloc(i64 40)
  %.207 = bitcast ptr %.206 to ptr
  call void @i64.array.init(ptr %.207)
  call void @print(ptr %.207)
  %.210 = call ptr @malloc(i64 40)
  %.211 = bitcast ptr %.210 to ptr
  call void @i64.array.init(ptr %.211)
  call void @i64.array.append(ptr %.211, i64 82)
  call void @i64.array.append(ptr %.211, i64 111)
  call void @i64.array.append(ptr %.211, i64 117)
  call void @i64.array.append(ptr %.211, i64 116)
  call void @i64.array.append(ptr %.211, i64 101)
  call void @i64.array.append(ptr %.211, i64 115)
  call void @i64.array.append(ptr %.211, i64 32)
  call void @i64.array.append(ptr %.211, i64 114)
  call void @i64.array.append(ptr %.211, i64 101)
  call void @i64.array.append(ptr %.211, i64 103)
  call void @i64.array.append(ptr %.211, i64 105)
  call void @i64.array.append(ptr %.211, i64 115)
  call void @i64.array.append(ptr %.211, i64 116)
  call void @i64.array.append(ptr %.211, i64 101)
  call void @i64.array.append(ptr %.211, i64 114)
  call void @i64.array.append(ptr %.211, i64 101)
  call void @i64.array.append(ptr %.211, i64 100)
  call void @i64.array.append(ptr %.211, i64 58)
  call void @print(ptr %.211)
  %.232 = call ptr @malloc(i64 40)
  %.233 = bitcast ptr %.232 to ptr
  call void @i64.array.init(ptr %.233)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 71)
  call void @i64.array.append(ptr %.233, i64 69)
  call void @i64.array.append(ptr %.233, i64 84)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 47)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 32)
  ...
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 45)
  call void @i64.array.append(ptr %.233, i64 62)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 72)
  call void @i64.array.append(ptr %.233, i64 111)
  call void @i64.array.append(ptr %.233, i64 109)
  call void @i64.array.append(ptr %.233, i64 101)
  call void @i64.array.append(ptr %.233, i64 32)
  call void @i64.array.append(ptr %.233, i64 112)
  call void @i64.array.append(ptr %.233, i64 97)
  call void @i64.array.append(ptr %.233, i64 103)
  call void @i64.array.append(ptr %.233, i64 101)
  call void @print(ptr %.233)
  %.264 = call ptr @malloc(i64 40)
  %.265 = bitcast ptr %.264 to ptr
  call void @i64.array.init(ptr %.265)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 71)
  call void @i64.array.append(ptr %.265, i64 69)
  call void @i64.array.append(ptr %.265, i64 84)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 47)
  call void @i64.array.append(ptr %.265, i64 104)
  call void @i64.array.append(ptr %.265, i64 101)
  call void @i64.array.append(ptr %.265, i64 108)
  call void @i64.array.append(ptr %.265, i64 108)
  call void @i64.array.append(ptr %.265, i64 111)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 45)
  call void @i64.array.append(ptr %.265, i64 62)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 84)
  call void @i64.array.append(ptr %.265, i64 101)
  call void @i64.array.append(ptr %.265, i64 120)
  call void @i64.array.append(ptr %.265, i64 116)
  call void @i64.array.append(ptr %.265, i64 32)
  call void @i64.array.append(ptr %.265, i64 103)
  call void @i64.array.append(ptr %.265, i64 114)
  call void @i64.array.append(ptr %.265, i64 101)
  call void @i64.array.append(ptr %.265, i64 101)
  call void @i64.array.append(ptr %.265, i64 116)
  call void @i64.array.append(ptr %.265, i64 105)
  call void @i64.array.append(ptr %.265, i64 110)
  call void @i64.array.append(ptr %.265, i64 103)
  call void @print(ptr %.265)
  %.300 = call ptr @malloc(i64 40)
  %.301 = bitcast ptr %.300 to ptr
  call void @i64.array.init(ptr %.301)
  call void @i64.array.append(ptr %.301, i64 32)
  call void @i64.array.append(ptr %.301, i64 32)
  call void @i64.array.append(ptr %.301, i64 71)
  call void @i64.array.append(ptr %.301, i64 69)
  call void @i64.array.append(ptr %.301, i64 84)
  call void @i64.array.append(ptr %.301, i64 32)
  call void @i64.array.append(ptr %.301, i64 47)
  call void @i64.array.append(ptr %.301, i64 97)
  call void @i64.array.append(ptr %.301, i64 112)
  call void @i64.array.append(ptr %.301, i64 105)
  call void @i64.array.append(ptr %.301, i64 47)
  call void @i64.array.append(ptr %.301, i64 105)
  call void @i64.array.append(ptr %.301, i64 110)
  call void @i64.array.append(ptr %.301, i64 102)
  call void @i64.array.append(ptr %.301, i64 111)
  call void @i64.array.append(ptr %.301, i64 32)
  call void @i64.array.append(ptr %.301, i64 45)
  call void @i64.array.append(ptr %.301, i64 62)
  call void @i64.array.append(ptr %.301, i64 32)
  call void @i64.array.append(ptr %.301, i64 83)
  call void @i64.array.append(ptr %.301, i64 101)
  call void @i64.array.append(ptr %.301, i64 114)
  call void @i64.array.append(ptr %.301, i64 118)
  call void @i64.array.append(ptr %.301, i64 101)
  call void @i64.array.append(ptr %.301, i64 114)
  call void @i64.array.append(ptr %.301, i64 32)
  call void @i64.array.append(ptr %.301, i64 105)
  ...
  call void @i64.array.append(ptr %.301, i64 111)
  call void @i64.array.append(ptr %.301, i64 32)
  call void @i64.array.append(ptr %.301, i64 74)
  call void @i64.array.append(ptr %.301, i64 83)
  call void @i64.array.append(ptr %.301, i64 79)
  call void @i64.array.append(ptr %.301, i64 78)
  call void @print(ptr %.301)
  %.339 = call ptr @malloc(i64 40)
  %.340 = bitcast ptr %.339 to ptr
  call void @i64.array.init(ptr %.340)
  call void @i64.array.append(ptr %.340, i64 32)
  call void @i64.array.append(ptr %.340, i64 32)
  call void @i64.array.append(ptr %.340, i64 71)
  call void @i64.array.append(ptr %.340, i64 69)
  call void @i64.array.append(ptr %.340, i64 84)
  call void @i64.array.append(ptr %.340, i64 32)
  call void @i64.array.append(ptr %.340, i64 47)
  call void @i64.array.append(ptr %.340, i64 97)
  call void @i64.array.append(ptr %.340, i64 112)
  call void @i64.array.append(ptr %.340, i64 105)
  call void @i64.array.append(ptr %.340, i64 47)
  call void @i64.array.append(ptr %.340, i64 116)
  call void @i64.array.append(ptr %.340, i64 105)
  call void @i64.array.append(ptr %.340, i64 109)
  call void @i64.array.append(ptr %.340, i64 101)
  call void @i64.array.append(ptr %.340, i64 32)
  call void @i64.array.append(ptr %.340, i64 45)
  call void @i64.array.append(ptr %.340, i64 62)
  call void @i64.array.append(ptr %.340, i64 32)
  call void @i64.array.append(ptr %.340, i64 84)
  call void @i64.array.append(ptr %.340, i64 105)
  call void @i64.array.append(ptr %.340, i64 109)
  call void @i64.array.append(ptr %.340, i64 101)
  call void @i64.array.append(ptr %.340, i64 32)
  call void @i64.array.append(ptr %.340, i64 74)
  call void @i64.array.append(ptr %.340, i64 83)
  call void @i64.array.append(ptr %.340, i64 79)
  call void @i64.array.append(ptr %.340, i64 78)
  call void @print(ptr %.340)
  %.371 = call ptr @malloc(i64 40)
  %.372 = bitcast ptr %.371 to ptr
  call void @i64.array.init(ptr %.372)
  call void @print(ptr %.372)
  %.375 = load ptr, ptr %server, align 8
  %.376 = call i64 @Server.listen(ptr %.375)
  br label %exit
...
rc_release.1:                                     ; preds = %exit
  ...
  %.384 = getelementptr %meteor.header, ptr %.383, i64 0, i32 0
  %.385 = load i32, ptr %.384, align 4
  %.386 = icmp eq i32 %.385, 1
  br i1 %.386, label %rc_destroy.1, label %rc_release_only.1

rc_release_continue.1:                            ; preds = %rc_release_only.1, %rc_destroy.1, %exit
  ret void

rc_destroy.1:                                     ; preds = %rc_release.1
  call void @__destroy_Server__(ptr %.378)
  %.389 = bitcast ptr %.378 to ptr
  %.390 = getelementptr i8, ptr %.389, i64 -16
  %.391 = bitcast ptr %.390 to ptr
  call void @meteor_release(ptr %.391)
  br label %rc_release_continue.1

rc_release_only.1:                                ; preds = %rc_release.1
  %.394 = bitcast ptr %.378 to ptr
  %.395 = getelementptr i8, ptr %.394, i64 -16
  %.396 = bitcast ptr %.395 to ptr
  call void @meteor_release(ptr %.396)
  br label %rc_release_continue.1
}
